    ...
    return [
      ...
      _section(
        ...
        '7.1. The Service offers both free and paid subscription tiers. Feature '
            ...
            '7.5. Refund Policy (Founder\'s Beta v1.0):\n'
            '  (a) Refund requests must be submitted within 14 days of the initial '
            'subscription purchase, in accordance with Article 9 of the EU Consumer '
            'Rights Directive 2011/83/EU;\n'
            '  (b) The 14-day withdrawal right expires earlier — specifically on the '
            'delivery of the 7th AI response of the subscription period — in '
            'accordance with Article 16(m) of the Directive (supply of digital '
            'content where performance has begun with the consumer\'s express prior '
            'consent and acknowledgement of loss of withdrawal right);\n'
            '  (c) The express consent in (b) is collected once per paid subscription '
            'through the in-app consent modal prior to the first AI response;\n'
            '  (d) Refund requests should be directed to info@advocat.ee, referencing '
            'the subscription e-mail and purchase date. Refunds are processed to the '
            'original Stripe payment method within 14 days of approval.\n\n'
