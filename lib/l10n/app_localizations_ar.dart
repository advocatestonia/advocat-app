...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get appTitle => 'Advocat — دفاع قانوني احترافي';

  @override
  String get onboardingTitle1 => 'فريق من الوكلاء القانونيين المحترفين';

  @override
  String get onboardingDesc1 =>
      'ليس روبوت محادثة — بل فريق كامل من المحامين المتخصصين بالذكاء الاصطناعي. خبراء هجرة، محللو قانون جنائي، باحثون في القانون الأوروبي، ومتخصصون في المستندات يعملون على قضيتك على مدار الساعة.';

  @override
  String get onboardingTitle2 => 'امسح ضوئياً — نحلّل كل شيء';

  @override
  String get onboardingDesc2 =>
      'صوّر أي مستند قانوني. وكلاؤنا يقرأونه بأي لغة، ويستخرجون كل تفصيل، ويقارنونه بقوانين بلدك.';

  @override
  String get onboardingTitle3 => 'أخطاء تفوت الشرطة والمحاكم';

  @override
  String get onboardingDesc3 =>
      'يفحص وكلاؤنا القانونيون أكثر من 40 نوعاً من المخالفات الإجرائية. في قضية حقيقية، اكتشفنا 3 أخطاء جوهرية فاتت حتى المحامين — لغة خاطئة، توقيع مزوّر، جنسية مغلوطة.';

  @override
  String get onboardingTitle4 => 'مستندات جاهزة للمحكمة في دقائق';

  @override
  String get onboardingDesc4 =>
      'طعون واعتراضات ورسائل قانونية احترافية يعدّها وكلاء متخصصون. قوانين مُستشهد بها، توجيهات أوروبية، وسوابق قضائية. جاهزة للتقديم.';
  ...
  @override
  String get fullDefense => 'الدفاع الكامل';
