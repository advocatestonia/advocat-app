...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get appearanceSystem => 'النظام (تلقائي)';
  ...
  @override
  String get appearanceDescription => 'اختر طريقة عرض تطبيق Advocat';
  ...
  String get chatWelcomeMessage =>
      'مرحبًا! أنا Advocat — مساعدك القانوني بالذكاء الاصطناعي. أقدّم معلومات قانونية، وليست استشارة قانونية. بأي سؤال قانوني يمكنني مساعدتك؟';
  ...
  String get aiDisclaimerCompact =>
      'يقدّم Advocat معلومات قانونية بالذكاء الاصطناعي، وليست استشارة قانونية. تحقّق من محامٍ مرخّص قبل اتخاذ أي إجراء.';

  @override
  String get aiDisclaimerFullTitle => 'مهم: كيف يعمل Advocat';

  @override
  String get aiDisclaimerFullBody =>
      'Advocat أداة ذكاء اصطناعي تقدّم معلومات قانونية، وليست استشارة قانونية. بموجب قانون الاتحاد الأوروبي للذكاء الاصطناعي (المادة 50)، يجب أن نُعلمك بوضوح: أنت تتفاعل مع ذكاء اصطناعي، وليس محاميًا بشريًا.\n\nAdvocat ليس مكتب محاماة. نحن لسنا محامين مرخّصين بموجب قانون المحاماة الإستوني (Advokatuuriseadus) أو القانون الفنلندي (Asianajajalaki)، ولا يسري امتياز السرية بين المحامي والموكل على محادثاتك مع هذه الأداة. قبل الاعتماد على أي مُخرج — لتقديم استئناف، أو توقيع عقد، أو التصرف بناءً على موعد نهائي — تحقّق من محامٍ مرخّص في ولايتك القضائية.';

  @override
  String get aiDisclaimerExpand => 'معرفة المزيد';

  @override
  String get aiDisclaimerDismiss => 'حسنًا، فهمت';
  ...
  String get aiGeneratedDisclaimer =>
      'تم إنشاؤه بالذكاء الاصطناعي • ليس استشارة قانونية';
  ...
  String get inheritanceDesc =>
      'الوصايا، التركات، حقوق الورثة، الميراث الإجباري، إجراءات التركة';

  @override
  String get rightInheritanceForced =>
      'يحقّ للورثة الإجباريين (الأبناء، الزوج/الزوجة) الحصول على نصيب إلزامي بغضّ النظر عن الوصية';

  @override
  String get rightInheritanceWill =>
      'يحقّ لك كتابة وصية تتصرّف بموجبها في ممتلكاتك — الوصايا الموثّقة لها أقوى قوة قانونية';

  @override
  String get rightInheritanceRenounce =>
      'يمكنك التنازل عن الميراث خلال 3 أشهر من علمك به';

  @override
  String get rightInheritanceInfo =>
      'يحقّ لك الحصول على معلومات عن التركة من البنوك والسجلات';

  @override
  String get rightInheritanceDispute =>
      'يمكنك الطعن في وصية غير عادلة أمام المحكمة خلال المدة القانونية للتقادم';

  @override
  String get mustFileInheritance =>
      'يجب فتح إجراءات التركة لدى كاتب عدل خلال مدة معقولة';

  @override
  String get mustNotifyHeirs =>
      'يجب إخطار جميع الورثة المعروفين بإجراءات التركة';

  @override
  String get inheritanceActionGatherDocs =>
      'اجمع جميع المستندات: شهادة الوفاة، الوصية، سجلات الملكية، كشوف الحسابات المصرفية';

  @override
  String get inheritanceActionContactNotary =>
      'تواصل مع كاتب عدل لفتح إجراءات التركة';

  @override
  String get inheritanceActionCheckDebts =>
      'تحقّق مما إذا كانت على التركة ديون قبل قبول الميراث';

  @override
  String get inheritanceActionFileCourt =>
      'في حال الطعن في الوصية، ارفع دعوى أمام المحكمة';

  @override
  String get inheritanceDeadlineRenounce =>
      '3 أشهر للتنازل عن الميراث بعد العلم به';

  @override
  String get inheritanceDeadlineDispute =>
      'مدة التقادم للطعن في الوصية: تختلف حسب الأسباب';

  @override
  String get inheritanceFactForced =>
      'في إستونيا، يحقّ للأبناء والزوج/الزوجة الحصول على نصيب إلزامي (نصف النصيب القانوني) حتى لو تم استبعادهم من الوصية';

  @override
  String get inheritanceFactNotary =>
      'يجب أن تتم جميع إجراءات التركة في إستونيا عبر كاتب عدل — لا يمكن تخطي هذه الخطوة';
  ...
  @override
  String get caseTypeStepLabel => 'نوع القضية';

  @override
  String get detailsStepLabel => 'التفاصيل';

  @override
  String get documentsStepLabel => 'المستندات';

  @override
  String get whatTypeOfCase => 'ما نوع هذه القضية؟';

  @override
  String get selectCategoryDescription => 'اختر الفئة التي تصف وضعك بأفضل شكل.';

  @override
  String get tellUsAboutCase => 'أخبرنا عن قضيتك';

  @override
  String get aiHelpsUnderstand =>
      'تساعد هذه المعلومات ذكاءنا الاصطناعي على فهم وضعك بشكل أفضل.';

  @override
  String get caseTitleHint => 'مثال: استئناف تصريح الإقامة 2026';

  @override
  String get countryJurisdiction => 'الدولة / الولاية القضائية';

  @override
  String get selectCountryHint => 'اختر دولة';

  @override
  String get referenceNumberHint => 'مثال: UMA/12345/2026';
  ...
  String get descriptionHint =>
      'صف وضعك باختصار. ماذا حدث؟ وما القرار الذي صدر؟';

  @override
  String get uploadFirstDocument => 'ارفع مستندك الأول';

  @override
  String get uploadDocumentDescription =>
      'ارفع خطاب القرار أو أي مستند ذي صلة. يمكنك تخطي هذه الخطوة وإضافة المستندات لاحقًا.';

  @override
  String get tapToUploadFile => 'اضغط لرفع ملف';

  @override
  String get fileSizeLimit => 'PDF أو JPG أو PNG حتى 25 ميجابايت';

  @override
  String get addDocumentsLaterHint =>
      'يمكنك دائمًا إضافة المستندات لاحقًا من شاشة تفاصيل القضية.';

  @override
  String get callAI => 'اتصل بالذكاء الاصطناعي';
  ...
  String get chatWelcomeSubtitle =>
      'سأحلّل الوضع، وأفحص المستندات، وأكتشف الأخطاء، وأقترح ما يجب فعله.';

  @override
  String get tapMicrophoneToSpeak => 'اضغط على الميكروفون للتحدث';

  @override
  String get categoryEssential => 'أساسي';

  @override
  String get categoryPolice => 'الشرطة';
  ...
  @override
  String get categoryConsumer => 'المستهلك';
  ...
  @override
  String get freeAidThreshold => 'حد المساعدة المجانية';

  @override
  String get partialAidThreshold => 'حد المساعدة الجزئية';

  @override
  String get assetLimit => 'حد الأصول';

  @override
  String get whereToApplyLabel => 'أين تقدّم الطلب';
  ...
  @override
  String get disclaimerCollapsed => 'إرشاد بالذكاء الاصطناعي فقط';

  @override
  String get disclaimerExpanded =>
      'مساعد ذكاء اصطناعي — ليس استشارة قانونية. تحقّق دائمًا من محامٍ مؤهّل.';

  @override
  String get chatDisclaimerBanner =>
      'يقدّم مساعد الذكاء الاصطناعي معلومات قانونية، وليست استشارة قانونية. استشر دائمًا محاميًا مؤهّلًا.';

  @override
  String get chatDisclaimerSubtitle =>
      'مساعد ذكاء اصطناعي · ليس استشارة قانونية';

  @override
  String get chatDisclaimerBannerFull =>
      'Advocat مساعد معلومات قانونية بالذكاء الاصطناعي، وليس محاميًا. لا تُنشئ المعلومات هنا علاقة محامٍ وموكّل، وليست استشارة قانونية، وقد تكون غير دقيقة. للحصول على استشارة قانونية ملزمة، استشر محاميًا مرخّصًا في ولايتك القضائية. نحن لا نمثّلك.';

  @override
  String get chatDisclaimerFooter =>
      'تم إنشاؤه بالذكاء الاصطناعي. تحقّق من محامٍ مرخّص.';

  @override
  String get chatDisclaimerGotIt => 'فهمت';
  ...
  @override
  String get deadlineRadarTitle => 'المواعيد النهائية القادمة';

  @override
  String get deadlineRadarEmpty => 'لا توجد مواعيد نهائية قادمة';

  @override
  String get deadlineRadarViewAll => 'عرض الكل';
  ...
  @override
  String get deadlineCardTomorrow => 'غدًا';

  @override
  String get deadlineCardToday => 'اليوم';
  ...
  @override
  String get deadlineCardMarkComplete => 'وضع علامة مكتمل';

  @override
  String get deadlineCardSnooze => 'تأجيل';

  @override
  String get deadlineCardSnooze3d => 'تأجيل 3 أيام';

  @override
  String get deadlineCardSnooze7d => 'تأجيل 7 أيام';

  @override
  String get deadlineCardSnoozeCustom => 'اختر تاريخًا';

  @override
  String get deadlineCardEdit => 'تعديل';

  @override
  String get deadlineCardDelete => 'أرشفة';

  @override
  String get deadlineCardSourceLabelPdf => 'من PDF';

  @override
  String get deadlineCardSourceLabelIntake => 'من الاستمارة الأولية';

  @override
  String get deadlineCardSourceLabelManual => 'أُضيف يدويًا';

  @override
  String get deadlineCardSourceLabelEmail => 'من البريد الإلكتروني';

  @override
  String get deadlineCardSourceLabelHaikuExtract => 'مستخرَج بالذكاء الاصطناعي';

  @override
  String get deadlineCardSourceLabelStatutoryTemplate => 'نموذج قانوني';

  @override
  String deadlineBannerCritical(String title, String when) {
    return 'موعد نهائي حرج $title $when';
  }

  @override
  String get deadlineBannerDismiss => 'إغلاق';

  @override
  String get deadlineBannerOpen => 'فتح الموعد النهائي';

  @override
  String deadlineHolidayShifted(String original, String reason) {
    return 'تم النقل من $original بسبب $reason';
  }

  @override
  String get deadlinePermissionAskTitle => 'تفعيل تذكيرات المواعيد النهائية؟';

  @override
  String get deadlinePermissionAskBody =>
      'سنُذكّرك قبل كل موعد نهائي قانوني بـ 7 و3 و1 يوم، بالإضافة إلى صباح اليوم نفسه. لن يُستخدم هذا أبدًا للتسويق.';

  @override
  String get deadlinePermissionAllow => 'السماح';

  @override
  String get deadlinePermissionLater => 'لاحقًا';

  @override
  String get deadlineSettingsSection => 'تذكيرات المواعيد النهائية';

  @override
  String get deadlineSettingsPushChannel => 'الإشعارات الفورية';

  @override
  String get deadlineSettingsEmailChannel => 'البريد الإلكتروني (الحرجة فقط)';

  @override
  String get deadlineSettingsInAppChannel => 'لافتات داخل التطبيق';

  @override
  String get deadlineSettingsCriticalBypass =>
      'تتجاوز التذكيرات الحرجة ساعات الهدوء';

  @override
  String get deadlineSettingsQuietHours => 'ساعات الهدوء';

  @override
  String deadlineSettingsQuietHoursBadge(String start, String end) {
    return 'هدوء $start–$end';
  }

  @override
  String get deadlineCaseScreenTitle => 'المواعيد النهائية للقضية';

  @override
  String get deadlineAddManualCta => 'إضافة موعد نهائي';

  @override
  String get deadlineFormTitle => 'العنوان';

  @override
  String get deadlineFormDescription => 'الوصف (اختياري)';

  @override
  String get deadlineFormStatuteTemplate => 'نموذج قانوني';

  @override
  String get deadlineFormStatuteTemplateNone => 'بلا (يدوي)';

  @override
  String get deadlineFormDeadlineAt => 'تاريخ الموعد النهائي';

  @override
  String get deadlineFormPriority => 'الأولوية';

  @override
  String get deadlineFormSave => 'حفظ';

  @override
  String get deadlineFormCancel => 'إلغاء';

  @override
  String get deadlineCompletedNotePrompt => 'أضف ملاحظة (اختياري)';

  @override
  String get deadlineCompletedNoteSave => 'حفظ';

  @override
  String get inboxTitle => 'صندوق الوارد';

  @override
  String get inboxEmptyTitle => 'لا يوجد شيء معلّق';

  @override
  String get inboxEmptyBody =>
      'ستظهر هنا سلاسل البريد الإلكتروني الجديدة عند فرزها.';

  @override
  String get inboxApproveSend => 'الموافقة والإرسال';

  @override
  String get inboxEditDraft => 'تعديل';

  @override
  String get inboxSnooze => 'تأجيل';

  @override
  String get inboxArchive => 'أرشفة';

  @override
  String get inboxFilterAll => 'الكل';

  @override
  String get inboxConfirmSendTitle => 'إرسال الرد المُعَدّ؟';

  @override
  String get inboxConfirmSendBody =>
      'سيقوم Advocat بإرسال الرد المُعَدّ بالذكاء الاصطناعي عبر Gmail المتصل بحسابك. يمكنك مراجعة النص في الشاشة التالية.';

  @override
  String get inboxSendButton => 'إرسال';

  @override
  String get inboxSentToast => 'تم الإرسال.';

  @override
  String get inboxAlreadySentToast => 'تم الإرسال مسبقًا.';

  @override
  String get inboxSendErrorToast => 'تعذّر إرسال الرد. اضغط لإعادة المحاولة.';

  @override
  String get inboxSnoozedToast => 'تم التأجيل لمدة 24 ساعة.';

  @override
  String get inboxArchivedToast => 'تمت الأرشفة.';

  @override
  String get inboxDraftLoadError => 'تعذّر تحميل المسودة.';

  @override
  String get inboxDeadlineToday => 'اليوم';

  @override
  String get inboxDeadlineTomorrow => 'غدًا';
  ...
  @override
  String get workspaceTabOverview => 'نظرة عامة';

  @override
  String get workspaceTabChat => 'المحادثة';

  @override
  String get workspaceTabDrafts => 'المسودات';

  @override
  String get workspaceOverviewEmpty => 'أضف مستندات لإنشاء ملخّص.';

  @override
  String get workspaceTimelineEmpty => 'لا توجد أحداث بعد.';

  @override
  String get workspaceDocumentsEmpty =>
      'لا توجد مستندات. ارفعها من المسح الضوئي.';

  @override
  String get workspaceDraftsEmpty => 'لا توجد مسودات بعد.';

  @override
  String get workspaceInboxEmpty => 'لا يوجد بريد إلكتروني ذو صلة.';
  ...
  @override
  String get contractReviews => 'مراجعات العقود';

  @override
  String get contractReviewsFreeFeature =>
      'مراجعة عقد واحدة (تجربة مدى الحياة)';

  @override
  String get contractReviewsCounselFeature => '5 مراجعات عقود شهريًا';

  @override
  String get contractReviewsProFeature => '20 مراجعة عقد شهريًا';
  ...
  String get contractReviewsExhausted =>
      'لم تعد لديك مراجعات عقود متبقية هذا الشهر';

  @override
  String get contractReviewsFreeTrialLeft =>
      'التجربة المجانية: مراجعة عقد واحدة';

  @override
  String get contractReviewsFreeTrialUsed =>
      'تم استخدام التجربة المجانية — قم بالترقية للمزيد';

  @override
  String get contractReviewsUpgradeTitle => 'تم استنفاد مراجعات العقود';

  @override
  String get contractReviewsUpgradeBodyFree =>
      'لقد استخدمت مراجعة عقدك المجانية. قم بالترقية للحصول على مراجعات شهرية.';

  @override
  String contractReviewsUpgradeBodyPaid(int used, int cap) {
    return 'لقد استخدمت $used من $cap مراجعة هذا الشهر. قم بالترقية للحصول على حد شهري أعلى.';
  }

  @override
  String get contractReviewsUpgradeCounselCta =>
      'الترقية إلى Counsel (19.99 يورو/شهر) — 5 مراجعات';

  @override
  String get contractReviewsUpgradeProCta =>
      'الترقية إلى Pro (29.99 يورو/شهر) — 20 مراجعة';

  @override
  String get contractReviewsUpgradeToProShort => 'الترقية إلى Pro — 20/شهر';
  ...
  @override
  String get checkerProTagline => 'أدوات تحقّق احترافية';

  @override
  String get checkerDataSource => 'بيانات من السجلات الرسمية';

  @override
  String get companyCheckerHint => 'اسم الشركة أو رقم التسجيل';

  @override
  String get companyCheckerPriceChip => '2.99 يورو لكل فحص  •  مشمول في Pro';

  @override
  String get companyCheckerEmptyState =>
      'أدخل اسم شركة أو رقم تسجيل\nللحصول على تقرير كامل';

  @override
  String get aiMemoryTitle => 'ذاكرة الذكاء الاصطناعي';

  @override
  String get aiMemorySubtitle => 'راجع وانسَ ما يتذكّره الذكاء الاصطناعي عنك';

  @override
  String get bookLawyerCallTitle => 'حجز مكالمة مع محامٍ';

  @override
  String get bookLawyerCallComingSoonTitle =>
      'مكالمات المحامين البشريين — تفتح قريبًا';

  @override
  String get bookLawyerCallComingSoonBody =>
      'تشمل باقتا Pro وPremium مكالمات مدتها 15 دقيقة مع محامٍ شريك (مرة كل ربع سنة في Pro، ومرتان في Premium). نعمل حاليًا على استكمال مجموعة المحامين المستقلين في إستونيا وسنراسلك بالبريد الإلكتروني فور فتح باب الحجز.';

  @override
  String bookLawyerCallQuotaAvailable(int remaining, int total) {
    return 'لديك $remaining من أصل $total مكالمة متبقية هذا الربع.';
  }

  @override
  String get bookLawyerCallQuotaExhausted => 'تم استخدام الحصة الربع سنوية.';

  @override
  String get bookLawyerCallQuotaBodyAvailable =>
      'تشمل باقة Pro مكالمة واحدة كل ربع سنة، وPremium مكالمتين. تستغرق المكالمات 15 دقيقة عبر Google Meet.';

  @override
  String get bookLawyerCallQuotaBodyExhausted =>
      'تُجدَّد حصتك في اليوم الأول من الربع القادم. تحتاج للتحدث في وقت أقرب؟ قم بالترقية إلى Premium للحصول على مكالمة إضافية.';
  ...
  @override
  String get deadlineRequiredFields => 'العنوان وتاريخ الموعد النهائي مطلوبان';

  @override
  String get acceptTermsRequired => 'يرجى الموافقة على شروط الخدمة';

  @override
  String get chatLegalCouncilTooltip => 'مجلس قانوني (4 خبراء)';
  ...
  @override
  String get stopGenerating => 'إيقاف التوليد';
  ...
  @override
  String get decreaseDependents => 'إنقاص';

  @override
  String get increaseDependents => 'زيادة';
  ...
  @override
  String get draftsTab => 'المسودات';

  @override
  String get draftingTitle => 'استوديو الصياغة';

  @override
  String get draftingEmpty => 'مسودة فارغة';

  @override
  String get draftingPlaceholder => 'ابدأ بكتابة مسودتك…';

  @override
  String get draftingDraftsList => 'مسوداتي';

  @override
  String get draftingSave => 'حفظ';

  @override
  String get draftingSaved => 'تم الحفظ';

  @override
  String get draftingSavedJustNow => 'تم الحفظ للتو';

  @override
  String get draftingAiRevise => 'مراجعة بالذكاء الاصطناعي';

  @override
  String get draftingExportPdf => 'تصدير PDF';

  @override
  String get draftingExportDocx => 'تصدير DOCX';

  @override
  String get draftingExportMd => 'تصدير Markdown';

  @override
  String get draftingDeleteDraft => 'حذف المسودة';

  @override
  String get draftingConfirmDelete => 'حذف هذه المسودة؟';

  @override
  String get draftingConfirmDeleteMessage => 'لا يمكن التراجع عن هذا الإجراء.';

  @override
  String get draftingConfirm => 'حذف';

  @override
  String get draftingCancel => 'إلغاء';
  ...
  @override
  String get draftingUntitled => 'بلا عنوان';

  @override
  String get draftingTitleHint => 'العنوان (اختياري)';

  @override
  String get draftingAiReviseTitle => 'مراجعة بالذكاء الاصطناعي';

  @override
  String get draftingAiReviseSelectionLabel => 'النص المحدد:';

  @override
  String get draftingAiReviseInstructionLabel => 'التعليمات (اختياري)';

  @override
  String get draftingAiReviseInstructionHint =>
      'مثال: \"اجعله أكثر رسمية\" أو \"اختصره\"';

  @override
  String get draftingAiReviseRunButton => 'إنشاء مراجعة';

  @override
  String get draftingAiReviseSuggestionLabel => 'المراجعة المقترحة:';

  @override
  String get draftingAiReviseChangesLabel => 'التغييرات:';

  @override
  String get draftingAiReviseAccept => 'قبول';

  @override
  String get draftingAiReviseReject => 'رفض';

  @override
  String get draftingFormatBold => 'عريض';

  @override
  String get draftingFormatItalic => 'مائل';

  @override
  String get draftingFormatHeading => 'عنوان';

  @override
  String get draftingFormatBullet => 'قائمة نقطية';

  @override
  String get draftingFormatNumbered => 'قائمة مرقّمة';

  @override
  String get draftingEmptyListMessage => 'ليس لديك مسودات بعد.';

  @override
  String get draftingEmptyListAction => 'مسودة جديدة';

  @override
  String get draftingExporting => 'جارٍ التصدير…';

  @override
  String get draftingExportFailed => 'فشل التصدير';

  @override
  String get draftingSaveFailed => 'فشل الحفظ';

  @override
  String get draftingNewDraft => 'مسودة جديدة';

  @override
  String get vaultNoteChip => 'ملاحظة الخزنة';

  @override
  String get saveToVault => 'الحفظ في الخزنة';
  ...
  @override
  String get vaultNoteTitlePrefix => 'ملاحظة: ';

  @override
  String get openInVault => 'فتح في الخزنة';

  @override
  String get saveToVaultFailed => 'فشل الحفظ في الخزنة';

  @override
  String get pdfWorkerUnavailable =>
      'تصدير PDF غير متاح مؤقتًا. يرجى تجربة DOCX أو Markdown.';

  @override
  String get draftingVersionHistory => 'سجل الإصدارات';

  @override
  String get emptyHomeTitle => 'مرحبًا بك في Advocat';

  @override
  String get emptyHomeBody =>
      'اختر نقطة بداية — وسنتولّى الجانب القانوني الشاق.';

  @override
  String get intentChip1 => 'حصلت على غرامة';

  @override
  String get intentChip2 => 'رُفض التصريح';

  @override
  String get intentChip3 => 'مشكلة في عقد';

  @override
  String get emptyCasesTitle => 'لا توجد قضايا بعد';

  @override
  String get emptyCasesCta => 'ابدأ قضية';

  @override
  String get emptyDraftsTitle => 'لا توجد مسودات بعد';

  @override
  String get emptyDraftsCta => 'إنشاء مسودة';

  @override
  String get emptyChatTitle => 'اسأل Advocat أي شيء';

  @override
  String get chatExamplePrompt1 => 'ساعدني في الرد على غرامة';

  @override
  String get chatExamplePrompt2 => 'راجع عقد إيجاري';
  ...
  @override
  String get contractReviewUploadCta => 'رفع العقد';

  @override
  String get contractReviewQuotaRemaining =>
      'ارفع عقدًا بصيغة PDF أو DOC أو DOCX أو TXT للحصول على مراجعة بالذكاء الاصطناعي تتضمن نقاط الخطر ونصائح التفاوض.';

  @override
  String get contractReviewRedFlags => 'نقاط الخطر';

  @override
  String get contractReviewReviewPoints => 'نقاط المراجعة';

  @override
  String get contractReviewNegotiationTips => 'نصائح التفاوض';

  @override
  String get contractReviewSaveToVault => 'الحفظ في الخزنة';

  @override
  String get contractReviewContinueChat => 'المتابعة في المحادثة';

  @override
  String get referralInviteFriends => 'دعوة الأصدقاء';

  @override
  String get referralYourCode => 'رمزك';

  @override
  String get referralCopiedToast => 'تم نسخ الرمز إلى الحافظة';

  @override
  String get referralReward =>
      'احصل على شهر مجاني من باقة Counsel مقابل كل صديق يشترك.';

  @override
  String get referralInvited => 'الأصدقاء المدعوّون';

  @override
  String get referralRewardsEarned => 'الأشهر المجانية المكتسبة';

  @override
  String get deadlineUrgencyToday => 'اليوم والمتأخرة';

  @override
  String get deadlineUrgencyWeek => 'هذا الأسبوع';

  @override
  String get deadlineUrgencyMonth => 'هذا الشهر';

  @override
  String get deadlineUrgencyLater => 'لاحقًا';

  @override
  String get deadlineAddManual => 'إضافة موعد نهائي';

  @override
  String get deadlineSnoozeBy => 'تأجيل';

  @override
  String get deadlineSnooze1d => 'تأجيل يوم واحد';

  @override
  String get deadlineSnooze3d => 'تأجيل 3 أيام';

  @override
  String get deadlineSnooze7d => 'تأجيل 7 أيام';

  @override
  String get deadlineDismiss => 'إغلاق';

  @override
  String get deadlineExportIcs => 'إضافة إلى التقويم';

  @override
  String get deadlineSource => 'المصدر';

  @override
  String get deadlineEmpty =>
      'لا توجد مواعيد نهائية بعد. تُنشأ المواعيد النهائية تلقائيًا من رسائلك ومستنداتك — أو أضف واحدًا يدويًا بزر +.';

  @override
  String get deadlineNewTitle => 'موعد نهائي جديد';

  @override
  String get deadlineFieldTitle => 'العنوان';

  @override
  String get deadlineFieldDueDate => 'تاريخ الاستحقاق';

  @override
  String get deadlineFieldNotes => 'ملاحظات (اختياري)';

  @override
  String get deadlineSaved => 'تم حفظ الموعد النهائي';

  @override
  String get deadlineSaveFailed => 'تعذّر حفظ الموعد النهائي';

  @override
  String get deadlineUrgentBannerSingle => 'موعد نهائي واحد اليوم أو متأخر';

  @override
  String deadlineUrgentBannerMany(int count) {
    return '$count مواعيد نهائية اليوم أو متأخرة';
  }
  ...
  String get deadlineEuRadarTitle =>
      'رادار المواعيد النهائية للاتحاد الأوروبي (معاينة)';

  @override
  String get deadlineEuRadarSubtitle =>
      'مواعيد نهائية إجرائية افتراضية للاتحاد الأوروبي — بيانات تجريبية';
  ...
  @override
  String get accessLogTile => 'سجل الوصول';

  @override
  String get accessLogTileSubtitle =>
      'اطّلع على من وصل إلى بياناتك وما الذي تم الوصول إليه';

  @override
  String get accessLogTitle => 'سجل الوصول إلى بياناتي';

  @override
  String get accessLogIntro =>
      'سجل شفاف ومحمي من العبث لكل مرة تم فيها الوصول إلى بياناتك أو معالجتها — بما في ذلك بواسطة الذكاء الاصطناعي لدينا. يمكنك التحقق من أنه لم يُعدَّل.';

  @override
  String get accessLogEmpty => 'لا توجد أحداث وصول حتى الآن.';

  @override
  String get accessLogError =>
      'تعذّر تحميل سجل الوصول الخاص بك. اسحب للأسفل لإعادة المحاولة.';

  @override
  String get accessLogIntegrityOk =>
      'تم التحقق من السلامة — تشكّل روابط السجل سلسلة متصلة غير منقطعة.';

  @override
  String get accessLogIntegrityBroken =>
      'تحذير: سلسلة السجل منقطعة. ربما تمّت إزالة بعض الإدخالات أو إعادة ترتيبها. يُرجى التواصل مع الدعم.';

  @override
  String get accessActionLlmEgress =>
      'أُرسل إلى الذكاء الاصطناعي للمعالجة (باسم مستعار)';

  @override
  String get accessActionAiAnalysis => 'تم تحليله بواسطة الذكاء الاصطناعي';

  @override
  String get accessActionDocumentParse => 'تم تحليل المستند';

  @override
  String get accessActionStaffRead => 'تمت مراجعته من قِبل أحد الموظفين';

  @override
  String get accessActionExport => 'تم تصدير البيانات';

  @override
  String get accessActionEmailTriage => 'تم فرز البريد الإلكتروني';

  @override
  String get accessActionDeadlineScan => 'تم فحص المهل';

  @override
  String get breachAlertTitle => 'تنبيه أمني بشأن بياناتك';

  @override
  String get breachAlertBody =>
      'اكتشفت مراقبتنا الآلية وصولاً غير معتاد يتعلق ببياناتك. نحن نراجعه وسنُبلغك بأي حادثة مؤكدة كما يقتضي القانون (المادة 34 من اللائحة العامة لحماية البيانات).';

  @override
  String get caseDossierTitle => 'تصدير ملف القضية';

  @override
  String get caseDossierSubtitle =>
      'ملف PDF واحد يضم كل شيء — الوقائع والتسلسل الزمني والمهل والمستندات — لتسليمه إلى محامٍ أو محكمة أو جهة شكوى.';

  @override
  String get caseDossierTileTitle => 'تصدير الملف (PDF)';

  @override
  String get caseDossierTileSubtitle =>
      'سلّم القضية كاملةً إلى محامٍ أو محكمة في ملف واحد';

  @override
  String get caseDossierSectionsHeading => 'ما يُضمّن في الملف';

  @override
  String get caseDossierSectionFacts => 'وقائع القضية';

  @override
  String get caseDossierSectionFactsHint => 'مُضمَّن دائماً';

  @override
  String get caseDossierSectionTimeline => 'التسلسل الزمني';

  @override
  String get caseDossierSectionDeadlines => 'المهل';

  @override
  String get caseDossierSectionDocuments => 'المستندات';

  @override
  String get caseDossierSectionAiSummary => 'ملخص الذكاء الاصطناعي';

  @override
  String get caseDossierExportButton => 'تصدير PDF';

  @override
  String get caseDossierExporting => 'جارٍ إنشاء ملفك…';

  @override
  String get caseDossierSuccess => 'الملف جاهز. افتح الملف أو شاركه.';

  @override
  String get caseDossierOpen => 'فتح الملف';

  @override
  String get caseDossierError => 'تعذّر إنشاء الملف. يُرجى المحاولة مرة أخرى.';

  @override
  String get caseDossierErrorNotOwned => 'تعذّر العثور على هذه القضية.';

  @override
  String get caseDossierDisclaimer =>
      'يعيد الملف إنتاج بيانات قضيتك كما هي مُسجَّلة. راجعها قبل المشاركة.';

  @override
  String get followupsTitle => 'الخطوات التالية';

  @override
  String get followupsSubtitle => 'مهام عملية للحفاظ على تقدّم قضيتك';

  @override
  String get followupsEmpty => 'لا توجد خطوات متابعة حتى الآن.';

  @override
  String get followupsEmptyDesc =>
      'أضف خطوة، أو دع الذكاء الاصطناعي يقترح ما تفعله تالياً.';

  @override
  String get followupsAdd => 'إضافة خطوة';

  @override
  String get followupsSuggest => 'اقتراح خطوات';

  @override
  String get followupsSuggestNone =>
      'لا توجد اقتراحات الآن. جرّب بعد الدردشة حول القضية.';

  @override
  String get followupsSuggestTitle => 'الخطوات التالية المقترحة';

  @override
  String get followupsAddPrompt => 'أضف الخطوات التي تريد الاحتفاظ بها:';

  @override
  String get followupsNewTitleHint => 'ما الذي يجب إنجازه؟';

  @override
  String get followupsNewDetailHint =>
      'ملاحظة اختيارية (لماذا / ما الذي يجب إرفاقه)';

  @override
  String get followupsDueOptional => 'ذكّرني في (اختياري)';

  @override
  String get followupsOverdue => 'متأخر';
  ...
  @override
  String get followupsDone => 'تم';

  @override
  String get followupsSnooze => 'تأجيل';

  @override
  String get followupsSnooze1Week => 'ذكّرني بعد أسبوع';

  @override
  String get followupsDismiss => 'تجاهل';

  @override
  String get followupsLoadError => 'تعذّر تحميل الخطوات التالية';

  @override
  String get followupsAiBadge => 'ذكاء اصطناعي';

  @override
  String get contractCompareTitle => 'مقارنة النسخ';

  @override
  String get contractCompareIntro =>
      'ارفع نسختين من العقد نفسه. سنُبرز ما تغيّر وما إذا كان كل تغيير في مصلحتك أم ضدك.';

  @override
  String get contractCompareOldVersion => 'النسخة القديمة (v1)';

  @override
  String get contractCompareNewVersion => 'النسخة الجديدة (v2)';

  @override
  String get contractCompareCta => 'مقارنة النسخ';

  @override
  String get contractCompareAdverse => 'في غير مصلحتك';

  @override
  String get contractCompareFavorable => 'في مصلحتك';

  @override
  String get contractCompareNeutral => 'محايد';

  @override
  String get contractCompareBefore => 'قبل';

  @override
  String get contractCompareAfter => 'بعد';

  @override
  String get contractCompareTruncated =>
      'عقد طويل — تمت مقارنة الجزء الأول فقط من كل نسخة.';

  @override
  String get contractCompareNoChanges =>
      'لم يُكتشف أي تغيير جوهري بين النسختين.';

  @override
  String get docSearchTitle => 'البحث في مستنداتي';

  @override
  String get docSearchHint => 'مثال: أين ذُكرت العربون';

  @override
  String get docSearchSubtitle => 'بحث دلالي عبر خزنتك وملفات قضيتك';

  @override
  String get docSearchIdle =>
      'ابحث في محتويات مستنداتك الخاصة — وليس العناوين فقط.';

  @override
  String get docSearchNoResults => 'لم يُعثر على أي تطابق في مستنداتك.';

  @override
  String get docSearchError => 'فشل البحث. يُرجى المحاولة مرة أخرى.';

  @override
  String get docSearchUntitled => 'مستند بلا عنوان';

  @override
  String get docSearchKindCase => 'مستند القضية';

  @override
  String get docSearchKindVault => 'مستند الخزنة';

  @override
  String get docSearchMenuTitle => 'البحث في مستنداتي';

  @override
  String get docSearchMenuSubtitle =>
      'اعثر على أي شيء في ملفاتك الخاصة بحسب المعنى';

  @override
  String get legalTemplatesTitle => 'مكتبة النماذج';

  @override
  String get legalTemplatesMenuLabel => 'النماذج';

  @override
  String get legalTemplatesSubtitle =>
      'اختر نموذجاً جاهزاً، واملأ بعض التفاصيل، وسننشئ مسودة يمكنك تحريرها وتصديرها.';

  @override
  String get legalTemplatesDisclaimer =>
      'هذه نماذج عامة استرشادية، وليست استشارة قانونية فردية. راجِعها وكيِّفها قبل الإرسال.';

  @override
  String get legalTemplatesSampleBadge => 'نموذج';

  @override
  String get legalTemplatesEmpty => 'لا توجد نماذج لهذا المُرشّح حتى الآن.';

  @override
  String get legalTemplatesError =>
      'تعذّر تحميل النماذج. يُرجى المحاولة مرة أخرى.';

  @override
  String get legalTemplatesFilterAll => 'الكل';

  @override
  String get legalTemplatesJurisdictionFi => 'فنلندا';

  @override
  String get legalTemplatesJurisdictionEe => 'إستونيا';

  @override
  String get legalTemplatesCategoryComplaint => 'الشكاوى';

  @override
  String get legalTemplatesCategoryAppeal => 'الاستئنافات';

  @override
  String get legalTemplatesCategoryApplication => 'الطلبات';

  @override
  String get legalTemplatesCategoryClaim => 'المطالبات';

  @override
  String get legalTemplatesCategoryRequest => 'الالتماسات';

  @override
  String get legalTemplatesFillTitle => 'املأ التفاصيل';

  @override
  String get legalTemplatesFillIntro =>
      'سنملأ اسمك وتفاصيل قضيتك تلقائياً. أكمل الحقول أدناه.';

  @override
  String get legalTemplatesFieldRequired => 'هذا الحقل مطلوب';

  @override
  String get legalTemplatesCreateDraft => 'إنشاء مسودة';

  @override
  String get legalTemplatesCreating => 'جارٍ إنشاء المسودة…';

  @override
  String get legalTemplatesCreateFailed =>
      'تعذّر إنشاء المسودة. يُرجى المحاولة مرة أخرى.';

  @override
  String get legalTemplatesUnresolvedWarning =>
      'ما زالت بعض الحقول فارغة ومُعلَّمة بـ ____ في المسودة. يمكنك إكمالها في المحرّر.';

  @override
  String get legalTemplatesFieldRecipient => 'المرسَل إليه (الجهة / المالك)';

  @override
  String get legalTemplatesFieldAddress => 'عنوانك البريدي';

  @override
  String get legalTemplatesFieldSubject => 'الموضوع';

  @override
  String get legalTemplatesFieldDescription => 'وصف المسألة';

  @override
  String get legalTemplatesFieldDemand => 'ما الذي تطالب به';

  @override
  String get checklistActionPlan => 'خطة العمل';

  @override
  String get checklistActionPlanSubtitle => 'خطوات لهذا النوع من القضايا';

  @override
  String checklistProgress(int completed, int total) {
    return 'تمّ إنجاز $completed من $total خطوة';
  }

  @override
  String get checklistAllDone => 'اكتملت جميع الخطوات';

  @override
  String get checklistEmpty =>
      'لا تتوفر خطة عمل لهذا النوع من القضايا حتى الآن.';
  ...
  String get checklistDisclaimer =>
      'هذه معلومات عامة وليست استشارة قانونية. المهل هي مُهل قانونية افتراضية — تأكّد من التاريخ الدقيق لقضيتك.';

  @override
  String get checklistViewPlan => 'عرض الخطة';

  @override
  String get explainPlainTitle => 'اشرح بكلمات بسيطة';

  @override
  String get explainPlainIntro =>
      'الصق رسالة رسمية أو قراراً أو عقداً وسنشرح ما يعنيه وما يطلبه منك — بلغة بسيطة.';

  @override
  String get explainPlainLevelFriend => 'كما لصديق';

  @override
  String get explainPlainLevelTerms => 'مع الإبقاء على المصطلحات القانونية';

  @override
  String get explainPlainInputHint => 'الصق النص القانوني هنا…';

  @override
  String get explainPlainSubmit => 'اشرح';

  @override
  String get explainPlainWorking => 'جارٍ الشرح…';

  @override
  String get explainPlainTldr => 'الخلاصة';

  @override
  String get explainPlainBreakdown => 'ما يقوله، جزءاً بجزء';

  @override
  String get explainPlainGlossary => 'شرح المصطلحات الصعبة';

  @override
  String get explainPlainNextSteps => 'ما يمكنك فعله تالياً';

  @override
  String get explainPlainOpenInCorpus => 'ابحث في مكتبة القانون';

  @override
  String get explainPlainEmptyResult =>
      'تعذّر إنتاج شرح لهذا النص. جرّب لصق مقتطف أطول أو أوضح.';

  @override
  String get explainPlainQuotaTitle =>
      'لقد استنفدت شروحاتك المجانية لهذا الشهر';

  @override
  String get explainPlainQuotaBody =>
      'تحصل الحسابات المجانية على 3 شروحات شهرياً. ترقَّ إلى Pro للحصول على شروحات غير محدودة.';

  @override
  String get explainPlainUpgradeCta => 'الترقية إلى Pro';

  @override
  String get explainPlainError =>
      'حدث خطأ أثناء شرح هذا النص. يُرجى المحاولة مرة أخرى.';

  @override
  String get explainPlainRetry => 'حاول مرة أخرى';

  @override
  String get demandLetterTitle => 'خطاب مطالبة';

  @override
  String get demandLetterSubtitle =>
      'أنشئ مطالبة رسمية قبل التقاضي (maksuvaatimus / nõudekiri).';

  @override
  String get demandLetterStepType => 'نوع المطالبة';

  @override
  String get demandLetterStepParties => 'الأطراف';

  @override
  String get demandLetterStepClaim => 'المبلغ والأساس';

  @override
  String get demandLetterStepDeadline => 'المهلة';

  @override
  String get demandLetterStepReview => 'المراجعة والإنشاء';

  @override
  String get demandLetterClaimDepositReturn => 'إعادة عربون الإيجار';

  @override
  String get demandLetterClaimUnpaidWage => 'أجور غير مدفوعة';

  @override
  String get demandLetterClaimFineDispute => 'الطعن في غرامة / رسم';

  @override
  String get demandLetterClaimGeneric => 'مطالبة مالية أخرى';

  @override
  String get demandLetterJurisdiction => 'الاختصاص القضائي';

  @override
  String get demandLetterLanguage => 'لغة الخطاب';

  @override
  String get demandLetterRecipientName => 'اسم المرسَل إليه';

  @override
  String get demandLetterRecipientAddress => 'عنوان المرسَل إليه (اختياري)';

  @override
  String get demandLetterSenderName => 'اسمك';

  @override
  String get demandLetterSenderAddress => 'عنوانك / بريدك الإلكتروني (اختياري)';

  @override
  String get demandLetterAmount => 'المبلغ';

  @override
  String get demandLetterCurrency => 'العملة';

  @override
  String get demandLetterBasis => 'ما الذي حدث (أساس المطالبة)';

  @override
  String get demandLetterBasisHint =>
      'صِف الوقائع: التواريخ والمبالغ وما تم الاتفاق عليه وما الذي حدث خطأً.';

  @override
  String get demandLetterDeadline => 'مهلة السداد';

  @override
  String get demandLetterDeadlineHint => 'مثال: 14 يوماً من اليوم';

  @override
  String get demandLetterReference => 'المرجع (اختياري)';

  @override
  String get demandLetterGenerate => 'إنشاء الخطاب';

  @override
  String get demandLetterGenerating => 'جارٍ الإنشاء…';

  @override
  String get demandLetterGenerateFailed =>
      'تعذّر إنشاء الخطاب. يُرجى المحاولة مرة أخرى.';

  @override
  String get demandLetterFieldRequired => 'هذا الحقل مطلوب';

  @override
  String get demandLetterNext => 'التالي';

  @override
  String get demandLetterBack => 'رجوع';

  @override
  String get demandLetterPreviewTitle => 'خطابك';

  @override
  String get demandLetterCopy => 'نسخ النص';

  @override
  String get demandLetterCopied => 'تم نسخ الخطاب إلى الحافظة';

  @override
  String get demandLetterExportPdf => 'تصدير PDF';

  @override
  String get demandLetterExporting => 'جارٍ التصدير…';

  @override
  String get demandLetterExportFailed =>
      'تعذّر تصدير المستند. يُرجى المحاولة مرة أخرى.';

  @override
  String get demandLetterSendEmail => 'إرسال عبر البريد الإلكتروني';

  @override
  String get demandLetterNormsTitle => 'المراجع القانونية';

  @override
  String get demandLetterDisclaimer =>
      'أُعدّ هذا الخطاب نيابةً عنك كنموذج عام. وهو ليس استشارة قانونية ولا عملاً صادراً عن محامٍ مرخَّص. راجِعه قبل الإرسال — لا يُرسَل أي خطاب تلقائياً.';

  @override
  String get demandLetterMenuTile => 'خطاب مطالبة';

  @override
  String get calcHubTitle => 'الحاسبات القانونية';

  @override
  String get calcHubSubtitle => 'تقديرات سريعة قبل خطوتك التالية';

  @override
  String get calcHubJurisdiction => 'الاختصاص القضائي';

  @override
  String calcRatesAsOf(String date) {
    return 'المعدلات اعتباراً من $date';
  }

  @override
  String get calcRatesOffline => 'عرض المعدلات المُخزّنة (دون اتصال)';

  @override
  String get calcIndicativeBanner =>
      'تقدير استرشادي فقط — وليس حساباً رسمياً أو استشارة قانونية.';

  @override
  String get calcCalculate => 'احسب';

  @override
  String get calcResult => 'النتيجة';

  @override
  String get calcFormula => 'كيف يُحسب هذا';

  @override
  String get calcSource => 'المصدر';

  @override
  String get calcSeveranceTitle => 'تعويض إنهاء الخدمة / مهلة الإشعار';

  @override
  String get calcSeveranceDesc =>
      'قدِّر تعويض إنهاء الخدمة ومهلة الإشعار عند التسريح';

  @override
  String get calcSeveranceSalary => 'الراتب الشهري الإجمالي';

  @override
  String get calcSeveranceTenure => 'سنوات الخدمة';

  @override
  String get calcSeveranceTotal => 'تعويض إنهاء الخدمة المقدَّر';

  @override
  String get calcSeveranceNotice => 'مهلة الإشعار';

  @override
  String get calcSeveranceGenerateDemand => 'صياغة خطاب مطالبة';

  @override
  String get calcLimitationTitle => 'مهل التقادم والاستئناف';

  @override
  String get calcLimitationDesc =>
      'تحقّق مما إذا كانت مهلة مطالبة أو استئناف قد انقضت';

  @override
  String get calcLimitationType => 'نوع المهلة';

  @override
  String get calcLimitationStart => 'تاريخ البدء (الواقعة / القرار)';

  @override
  String get calcLimitationPickDate => 'اختر التاريخ';

  @override
  String get calcLimitationDeadline => 'المهلة';

  @override
  String get calcLimitationExpired => 'انقضت المهلة';
  ...
  String get calcLimitationShifted =>
      'تم ترحيلها إلى يوم العمل التالي (عطلة نهاية الأسبوع/عطلة رسمية).';

  @override
  String get calcLimitationAddDeadline => 'إضافة إلى المهل';

  @override
  String get calcStateFeeTitle => 'الرسوم القضائية / رسوم الدولة';

  @override
  String get calcStateFeeDesc => 'رسوم الإيداع المرجعية بحسب المحكمة والمرحلة';

  @override
  String get calcChildSupportTitle => 'نفقة الطفل (استرشادية)';

  @override
  String get calcChildSupportDesc =>
      'رقم استرشادي تقريبي — يُحدَّد المبلغ الفعلي لكل حالة على حدة';

  @override
  String get calcChildSupportNet => 'صافي الدخل الشهري للملتزم بالدفع';

  @override
  String get calcChildSupportChildren => 'عدد الأطفال';

  @override
  String get calcChildSupportPerChild => 'لكل طفل';

  @override
  String get calcChildSupportTotal => 'الإجمالي الشهري';

  @override
  String get calcChildSupportWarning =>
      'متغير للغاية. تقرّر المحاكم بناءً على احتياجات الطفل وقدرة كلا الوالدين على الدفع. استخدمها كنقطة بداية فقط.';

  @override
  String get docCollectTitle => 'المستندات المطلوب جمعها';

  @override
  String get docCollectSubtitle =>
      'اجمع هذه المستندات قبل أن تتقدّم بطلب أو تذهب إلى المحكمة';

  @override
  String get docCollectPickPrompt => 'ما هو وضعك؟';

  @override
  String get docCollectProblemResidence => 'تصريح الإقامة';

  @override
  String get docCollectProblemTenant => 'الإيجار / الإخلاء';

  @override
  String get docCollectProblemDismissal => 'الفصل من العمل';

  @override
  String get docCollectProblemInheritance => 'الميراث';

  @override
  String get docCollectProblemDivorce => 'الطلاق';

  @override
  String docCollectProgress(int collected, int total) {
    return 'تم جمع $collected من $total';
  }

  @override
  String get docCollectAllDone => 'تم جمع كل شيء';

  @override
  String get docCollectEmpty => 'لا تتوفر قائمة مستندات لهذا الوضع حتى الآن.';

  @override
  String get docCollectOptional => 'اختياري';

  @override
  String get docCollectWhereLabel => 'أين تحصل عليه';

  @override
  String get docCollectWhyLabel => 'لماذا هو مطلوب';

  @override
  String get docCollectAttach => 'إرفاق ملف';

  @override
  String get docCollectAttached => 'تم إرفاق الملف';

  @override
  String get docCollectChangeFile => 'تغيير الملف';

  @override
  String get docCollectRemoveFile => 'إزالة الملف';

  @override
  String get docCollectNoFiles => 'لم ترفع أي مستندات بعد.';

  @override
  String get docCollectPickFileTitle => 'اختر مستنداً مرفوعاً';

  @override
  String get docCollectExport => 'تصدير القائمة';

  @override
  String get docCollectExportSubject => 'قائمة مستنداتي المرجعية';

  @override
  String get docCollectAiTitle => 'هل تحتاج شيئاً محدداً؟';

  @override
  String get docCollectAiHint => 'صِف وضعك وسنقترح أي مستندات إضافية.';

  @override
  String get docCollectAiField => 'صِف وضعك';

  @override
  String get docCollectAiButton => 'اقتراح مستندات إضافية';

  @override
  String get docCollectAiLoading => 'جارٍ التفكير…';

  @override
  String get docCollectAiEmpty =>
      'لم تُقترح مستندات إضافية — تبدو القائمة الأساسية مكتملةً بناءً على وصفك.';

  @override
  String get docCollectAiSuggestionsTitle => 'المستندات الإضافية المقترحة';

  @override
  String get docCollectDisclaimer =>
      'هذه قائمة أساسية بالمستندات المطلوبة عادةً — قد يتطلب وضعك مستندات أكثر أو أقل. إنها معلومات عامة وليست استشارة قانونية.';

  @override
  String get docCollectRetry => 'حاول مرة أخرى';

  @override
  String get renewalTitle => 'رادار التجديد';

  @override
  String get renewalSubtitle =>
      'تتبّع مواعيد انتهاء تصاريحك وجواز سفرك وتأمينك ومستنداتك الأخرى. سنذكّرك قبل 90 و30 و7 أيام من كل تجديد.';

  @override
  String get renewalAdd => 'إضافة مستند';

  @override
  String get renewalEditTitle => 'تعديل المستند';

  @override
  String get renewalSave => 'حفظ';

  @override
  String get renewalRequired => 'مطلوب';

  @override
  String get renewalPickDate => 'اختر تاريخ الانتهاء';

  @override
  String get renewalLoadError => 'تعذّر تحميل مستنداتك. اسحب للتحديث.';

  @override
  String get renewalEmptyTitle => 'لا توجد مستندات متتبَّعة حتى الآن';

  @override
  String get renewalEmptyBody =>
      'أضف تصريح إقامتك أو جواز سفرك أو تأمينك أو رخصتك وسنراقب تواريخ الانتهاء نيابةً عنك.';

  @override
  String get renewalGuideHint => 'كيفية التجديد ←';

  @override
  String get renewalFieldType => 'نوع المستند';

  @override
  String get renewalFieldLabel => 'التسمية';

  @override
  String get renewalFieldNumber => 'رقم المستند (اختياري)';

  @override
  String get renewalFieldJurisdiction => 'بلد الإصدار';

  @override
  String get renewalFieldExpiry => 'تاريخ الانتهاء';

  @override
  String get renewalWindow90 => '90 يوماً';

  @override
  String get renewalWindow30 => '30 يوماً';

  @override
  String get renewalWindow7 => '7 أيام';

  @override
  String get renewalExpiresToday => 'ينتهي اليوم';

  @override
  String renewalExpiresInDays(int days, String date) {
    return 'ينتهي خلال $days يوماً · $date';
  }
  ...
  @override
  String get renewalTypeResidencePermit => 'تصريح الإقامة';

  @override
  String get renewalTypePassport => 'جواز السفر';

  @override
  String get renewalTypeIdCard => 'بطاقة الهوية';

  @override
  String get renewalTypeVisa => 'تأشيرة';

  @override
  String get renewalTypeDrivingLicence => 'رخصة القيادة';

  @override
  String get renewalTypeInsurance => 'التأمين';

  @override
  String get renewalTypeWorkPermit => 'تصريح العمل';

  @override
  String get renewalTypeOther => 'أخرى';

  @override
  String get costEstimateTitle => 'مُقدِّر التكلفة والمخاطر';

  @override
  String get costEstimateSubtitle =>
      'احصل على فكرة تقريبية عمّا قد تكلّفه القضية، والمدة التي قد تستغرقها، وما إذا كان من المجدي المضي فيها.';

  @override
  String get costEstimateCaseTypeLabel => 'نوع القضية';

  @override
  String get costEstimateCaseTypeHint =>
      'مثال: فاتورة غير مدفوعة، فصل تعسفي، نزاع على عربون';

  @override
  String get costEstimateJurisdictionLabel => 'الاختصاص القضائي';

  @override
  String get costEstimateAmountLabel => 'المبلغ محل النزاع (اختياري)';

  @override
  String get costEstimateAmountHint => 'مثال: 12500';

  @override
  String get costEstimateDescriptionLabel => 'صِف الوضع باختصار (اختياري)';

  @override
  String get costEstimateB2bToggle => 'بطاقة تأهيل العميل المحتمل (B2B)';

  @override
  String get costEstimateB2bSubtitle => 'مخرجات مُوجزة لفرز عميل وارد بسرعة.';

  @override
  String get costEstimateSubmit => 'قدِّر قضيتي';

  @override
  String get costEstimateDisclaimer =>
      'تقدير تقريبي فقط — وليس تنبؤاً أو ضماناً أو استشارة قانونية. تختلف التكاليف والنتائج الفعلية لكل قضية على حدة.';

  @override
  String get costEstimateCostsHeading => 'التكاليف المقدَّرة';

  @override
  String get costEstimateCourtFee => 'الرسم القضائي / رسم الدولة';

  @override
  String get costEstimateLawyerFee => 'أتعاب المحامي';

  @override
  String get costEstimateTotal => 'الإجمالي (تقريبي)';

  @override
  String get costEstimateDuration => 'الوقت حتى أول حل';

  @override
  String get costEstimateMonthsSuffix => 'أشهر';

  @override
  String get costEstimateFactorsFor => 'في مصلحتك';

  @override
  String get costEstimateFactorsAgainst => 'ضدك';

  @override
  String get costEstimateStrengthWorth => 'يُرجَّح أن يستحق المتابعة';

  @override
  String get costEstimateStrengthContested =>
      'متنازَع عليه — قد يميل لأي من الجانبين';
