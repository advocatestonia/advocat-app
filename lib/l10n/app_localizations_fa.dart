...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get appearanceSystem => 'سیستم (خودکار)';
  ...
  String get appearanceDescription =>
      'نحوه نمایش اپلیکیشن Advocat را انتخاب کنید';
  ...
  String get chatWelcomeMessage =>
      'سلام! من Advocat هستم — دستیار حقوقی هوش مصنوعی شما. من اطلاعات حقوقی ارائه می‌دهم، نه مشاوره حقوقی. در چه موضوع حقوقی می‌توانم کمک کنم؟';
  ...
  String get aiDisclaimerCompact =>
      'Advocat یک ابزار هوش مصنوعی برای اطلاعات حقوقی است، نه مشاوره حقوقی رسمی. پیش از اقدام، با یک وکیل دارای پروانه تأیید کنید.';

  @override
  String get aiDisclaimerFullTitle => 'توجه: نحوه عملکرد Advocat';

  @override
  String get aiDisclaimerFullBody =>
      'Advocat یک ابزار مبتنی بر هوش مصنوعی است که اطلاعات حقوقی ارائه می‌دهد، نه مشاوره حقوقی. طبق قانون هوش مصنوعی اتحادیه اروپا (ماده ۵۰)، موظفیم به‌روشنی اعلام کنیم: شما در حال تعامل با هوش مصنوعی هستید، نه یک وکیل انسانی.\n\nAdvocat یک مؤسسه حقوقی نیست. ما تحت قانون وکالت استونی (Advokatuuriseadus) یا قانون وکالت فنلاند (Asianajajalaki) وکیل دارای پروانه نیستیم و رازداری وکیل-موکل شامل مکالمات شما با این ابزار نمی‌شود. پیش از اتکا به هر خروجی — برای ثبت تجدیدنظر، امضای قرارداد یا اقدام بر اساس یک مهلت قانونی — با یک وکیل دارای پروانه در حوزه قضایی خود تأیید کنید.';

  @override
  String get aiDisclaimerExpand => 'بیشتر بدانید';

  @override
  String get aiDisclaimerDismiss => 'متوجه شدم';
  ...
  String get aiGeneratedDisclaimer =>
      'تولیدشده توسط هوش مصنوعی • مشاوره حقوقی نیست';
  ...
  String get inheritanceDesc =>
      'وصیت‌نامه، ترکه، حقوق وارثان، سهم اجباری وراث، فرآیند اثبات وصیت';

  @override
  String get rightInheritanceForced =>
      'وارثان اجباری (فرزندان، همسر) صرف‌نظر از مفاد وصیت‌نامه مستحق سهم اجباری هستند';

  @override
  String get rightInheritanceWill =>
      'شما حق دارید وصیت‌نامه‌ای برای واگذاری اموال خود تنظیم کنید — وصیت‌نامه‌های تنظیم‌شده نزد سردفتر بیشترین اعتبار قانونی را دارند';

  @override
  String get rightInheritanceRenounce =>
      'می‌توانید ظرف ۳ ماه از زمان اطلاع، ارث را رد کنید';

  @override
  String get rightInheritanceInfo =>
      'شما حق دارید از بانک‌ها و سازمان‌های ثبتی درباره ترکه اطلاعات دریافت کنید';

  @override
  String get rightInheritanceDispute =>
      'می‌توانید در مهلت قانونی، وصیت‌نامه ناعادلانه را در دادگاه به چالش بکشید';

  @override
  String get mustFileInheritance =>
      'درخواست فرآیند ارث‌بری باید در مهلت معقول نزد سردفتر ثبت شود';

  @override
  String get mustNotifyHeirs =>
      'باید به همه وارثان شناخته‌شده درباره فرآیند ارث‌بری اطلاع داده شود';

  @override
  String get inheritanceActionGatherDocs =>
      'همه مدارک را جمع‌آوری کنید: گواهی فوت، وصیت‌نامه، اسناد مالکیت، صورت‌حساب‌های بانکی';

  @override
  String get inheritanceActionContactNotary =>
      'برای آغاز فرآیند ارث‌بری با یک سردفتر تماس بگیرید';

  @override
  String get inheritanceActionCheckDebts =>
      'پیش از پذیرش ارث، بدهی‌های احتمالی ترکه را بررسی کنید';

  @override
  String get inheritanceActionFileCourt =>
      'در صورت اختلاف بر سر وصیت‌نامه، دادخواست در دادگاه ثبت کنید';

  @override
  String get inheritanceDeadlineRenounce =>
      '۳ ماه مهلت برای رد ارث پس از اطلاع از آن';

  @override
  String get inheritanceDeadlineDispute =>
      'مهلت قانونی برای اعتراض به وصیت‌نامه: بسته به مبنای اعتراض متفاوت است';

  @override
  String get inheritanceFactForced =>
      'در استونی، فرزندان و همسر حتی در صورت حذف از وصیت‌نامه، حق سهم اجباری (نیمی از سهم قانونی) دارند';

  @override
  String get inheritanceFactNotary =>
      'همه فرآیندهای ارث‌بری در استونی باید از طریق سردفتر انجام شود — نمی‌توان این مرحله را نادیده گرفت';
  ...
  @override
  String get caseTypeStepLabel => 'نوع پرونده';

  @override
  String get detailsStepLabel => 'جزئیات';

  @override
  String get documentsStepLabel => 'مدارک';

  @override
  String get whatTypeOfCase => 'این پرونده از چه نوعی است؟';

  @override
  String get selectCategoryDescription =>
      'دسته‌ای را که وضعیت شما را بهتر توصیف می‌کند انتخاب کنید.';

  @override
  String get tellUsAboutCase => 'درباره پرونده خود به ما بگویید';

  @override
  String get aiHelpsUnderstand =>
      'این اطلاعات به هوش مصنوعی ما کمک می‌کند وضعیت شما را بهتر درک کند.';

  @override
  String get caseTitleHint => 'مثلاً: تجدیدنظر اجازه اقامت ۲۰۲۶';

  @override
  String get countryJurisdiction => 'کشور / حوزه قضایی';

  @override
  String get selectCountryHint => 'یک کشور انتخاب کنید';

  @override
  String get referenceNumberHint => 'مثلاً: UMA/12345/2026';
  ...
  String get descriptionHint =>
      'وضعیت خود را به‌طور مختصر شرح دهید. چه اتفاقی افتاد؟ چه تصمیمی گرفته شد؟';

  @override
  String get uploadFirstDocument => 'اولین سند خود را بارگذاری کنید';

  @override
  String get uploadDocumentDescription =>
      'نامه تصمیم یا هر سند مرتبط را بارگذاری کنید. می‌توانید این مرحله را رد کرده و بعداً مدارک اضافه کنید.';

  @override
  String get tapToUploadFile => 'برای بارگذاری فایل ضربه بزنید';

  @override
  String get fileSizeLimit => 'PDF، JPG، PNG تا ۲۵ مگابایت';

  @override
  String get addDocumentsLaterHint =>
      'همیشه می‌توانید بعداً از صفحه جزئیات پرونده، مدارک اضافه کنید.';

  @override
  String get callAI => 'تماس با هوش مصنوعی';
  ...
  String get chatWelcomeSubtitle =>
      'وضعیت را تحلیل می‌کنم، مدارک را بررسی می‌کنم، خطاها را پیدا می‌کنم و پیشنهاد می‌دهم چه اقدامی انجام دهید.';

  @override
  String get tapMicrophoneToSpeak => 'برای صحبت‌کردن روی میکروفون ضربه بزنید';

  @override
  String get categoryEssential => 'ضروری';

  @override
  String get categoryPolice => 'پلیس';

  @override
  String get categoryWork => 'کار';

  @override
  String get categoryHousing => 'مسکن';

  @override
  String get categoryConsumer => 'مصرف‌کننده';
  ...
  @override
  String get freeAidThreshold => 'آستانه کمک رایگان';

  @override
  String get partialAidThreshold => 'آستانه کمک جزئی';

  @override
  String get assetLimit => 'سقف دارایی';

  @override
  String get whereToApplyLabel => 'محل درخواست';
  ...
  @override
  String get disclaimerCollapsed => 'راهنمایی هوش مصنوعی فقط';

  @override
  String get disclaimerExpanded =>
      'دستیار هوش مصنوعی — مشاوره حقوقی نیست. همیشه با یک وکیل واجد شرایط تأیید کنید.';

  @override
  String get chatDisclaimerBanner =>
      'دستیار هوش مصنوعی اطلاعات حقوقی ارائه می‌دهد، نه مشاوره حقوقی. همیشه با یک وکیل واجد شرایط مشورت کنید.';

  @override
  String get chatDisclaimerSubtitle => 'دستیار هوش مصنوعی · مشاوره حقوقی نیست';

  @override
  String get chatDisclaimerBannerFull =>
      'Advocat یک دستیار هوش مصنوعی برای اطلاعات حقوقی است، نه وکیل. اطلاعات این‌جا رابطه وکیل-موکل ایجاد نمی‌کند، مشاوره حقوقی نیست و ممکن است نادرست باشد. برای مشاوره حقوقی الزام‌آور، با یک وکیل دارای پروانه در حوزه قضایی خود مشورت کنید. ما نماینده شما نیستیم.';

  @override
  String get chatDisclaimerFooter =>
      'تولیدشده توسط هوش مصنوعی. با یک وکیل دارای پروانه تأیید کنید.';

  @override
  String get chatDisclaimerGotIt => 'متوجه شدم';
  ...
  @override
  String get deadlineRadarTitle => 'مهلت‌های پیش‌رو';

  @override
  String get deadlineRadarEmpty => 'مهلت پیش‌رویی وجود ندارد';

  @override
  String get deadlineRadarViewAll => 'مشاهده همه';
  ...
  @override
  String get deadlineCardTomorrow => 'فردا';

  @override
  String get deadlineCardToday => 'امروز';
  ...
  @override
  String get deadlineCardMarkComplete => 'علامت‌گذاری به‌عنوان انجام‌شده';

  @override
  String get deadlineCardSnooze => 'به تعویق انداختن';

  @override
  String get deadlineCardSnooze3d => '۳ روز به تعویق بیفتد';

  @override
  String get deadlineCardSnooze7d => '۷ روز به تعویق بیفتد';

  @override
  String get deadlineCardSnoozeCustom => 'انتخاب تاریخ';

  @override
  String get deadlineCardEdit => 'ویرایش';

  @override
  String get deadlineCardDelete => 'بایگانی';

  @override
  String get deadlineCardSourceLabelPdf => 'از PDF';

  @override
  String get deadlineCardSourceLabelIntake => 'از فرم ورودی';

  @override
  String get deadlineCardSourceLabelManual => 'افزوده‌شده به‌صورت دستی';

  @override
  String get deadlineCardSourceLabelEmail => 'از ایمیل';

  @override
  String get deadlineCardSourceLabelHaikuExtract =>
      'استخراج‌شده توسط هوش مصنوعی';

  @override
  String get deadlineCardSourceLabelStatutoryTemplate => 'قالب قانونی';

  @override
  String deadlineBannerCritical(String title, String when) {
    return 'مهلت حیاتی $title $when';
  }

  @override
  String get deadlineBannerDismiss => 'بستن';

  @override
  String get deadlineBannerOpen => 'باز کردن مهلت';

  @override
  String deadlineHolidayShifted(String original, String reason) {
    return 'به دلیل $reason از $original جابه‌جا شد';
  }

  @override
  String get deadlinePermissionAskTitle => 'یادآوری مهلت‌ها فعال شود؟';

  @override
  String get deadlinePermissionAskBody =>
      '۷، ۳ و ۱ روز پیش از هر مهلت قانونی، به‌علاوه صبح همان روز به شما اطلاع می‌دهیم. هرگز برای تبلیغات استفاده نمی‌شود.';

  @override
  String get deadlinePermissionAllow => 'اجازه بده';

  @override
  String get deadlinePermissionLater => 'بعداً';

  @override
  String get deadlineSettingsSection => 'یادآوری مهلت‌ها';

  @override
  String get deadlineSettingsPushChannel => 'اعلان‌های فوری';

  @override
  String get deadlineSettingsEmailChannel => 'ایمیل (فقط موارد حیاتی)';

  @override
  String get deadlineSettingsInAppChannel => 'بنرهای درون‌برنامه‌ای';

  @override
  String get deadlineSettingsCriticalBypass =>
      'یادآوری‌های حیاتی از ساعات آرام صرف‌نظر می‌کنند';

  @override
  String get deadlineSettingsQuietHours => 'ساعات آرام';

  @override
  String deadlineSettingsQuietHoursBadge(String start, String end) {
    return 'آرام $start–$end';
  }

  @override
  String get deadlineCaseScreenTitle => 'مهلت‌های پرونده';

  @override
  String get deadlineAddManualCta => 'افزودن مهلت';

  @override
  String get deadlineFormTitle => 'عنوان';

  @override
  String get deadlineFormDescription => 'توضیحات (اختیاری)';

  @override
  String get deadlineFormStatuteTemplate => 'قالب قانونی';

  @override
  String get deadlineFormStatuteTemplateNone => 'هیچ‌کدام (دستی)';

  @override
  String get deadlineFormDeadlineAt => 'تاریخ مهلت';

  @override
  String get deadlineFormPriority => 'اولویت';

  @override
  String get deadlineFormSave => 'ذخیره';

  @override
  String get deadlineFormCancel => 'لغو';

  @override
  String get deadlineCompletedNotePrompt => 'افزودن یادداشت (اختیاری)';

  @override
  String get deadlineCompletedNoteSave => 'ذخیره';

  @override
  String get inboxTitle => 'صندوق ورودی';

  @override
  String get inboxEmptyTitle => 'موردی در انتظار نیست';

  @override
  String get inboxEmptyBody =>
      'رشته‌های ایمیل جدید پس از دسته‌بندی این‌جا نمایش داده می‌شوند.';

  @override
  String get inboxApproveSend => 'تأیید و ارسال';

  @override
  String get inboxEditDraft => 'ویرایش';

  @override
  String get inboxSnooze => 'به تعویق انداختن';

  @override
  String get inboxArchive => 'بایگانی';

  @override
  String get inboxFilterAll => 'همه';

  @override
  String get inboxConfirmSendTitle => 'پاسخ آماده‌شده ارسال شود؟';

  @override
  String get inboxConfirmSendBody =>
      'Advocat پاسخ آماده‌شده توسط هوش مصنوعی را از طریق Gmail متصل شما ارسال می‌کند. همچنان می‌توانید متن را در صفحه بعدی بازبینی کنید.';

  @override
  String get inboxSendButton => 'ارسال';

  @override
  String get inboxSentToast => 'ارسال شد.';

  @override
  String get inboxAlreadySentToast => 'قبلاً ارسال شده است.';

  @override
  String get inboxSendErrorToast =>
      'ارسال پاسخ ممکن نشد. برای تلاش مجدد ضربه بزنید.';

  @override
  String get inboxSnoozedToast => 'به مدت ۲۴ ساعت به تعویق افتاد.';

  @override
  String get inboxArchivedToast => 'بایگانی شد.';

  @override
  String get inboxDraftLoadError => 'بارگذاری پیش‌نویس ممکن نشد.';

  @override
  String get inboxDeadlineToday => 'امروز';

  @override
  String get inboxDeadlineTomorrow => 'فردا';
  ...
  String inboxDeadlineOverdue(int days) {
    return '$days روز از سررسید گذشته';
  }
  ...
  @override
  String get workspaceTabOverview => 'نمای کلی';

  @override
  String get workspaceTabChat => 'گفتگو';

  @override
  String get workspaceTabDrafts => 'پیش‌نویس‌ها';

  @override
  String get workspaceOverviewEmpty => 'برای ساخت خلاصه، مدارک اضافه کنید.';

  @override
  String get workspaceTimelineEmpty => 'هنوز رویدادی وجود ندارد.';

  @override
  String get workspaceDocumentsEmpty =>
      'مدرکی وجود ندارد. از بخش اسکن بارگذاری کنید.';

  @override
  String get workspaceDraftsEmpty => 'هنوز پیش‌نویسی وجود ندارد.';

  @override
  String get workspaceInboxEmpty => 'ایمیل مرتبطی وجود ندارد.';
  ...
  @override
  String get supportContactTelegram => 'تلگرام';

  @override
  String get supportContactWhatsapp => 'واتس‌اپ';

  @override
  String get supportFooterSla => 'ظرف ۲۴ ساعت پاسخ می‌دهیم';

  @override
  String get supportWhatsapp => 'واتس‌اپ';
  ...
  @override
  String get contractReviews => 'بررسی قراردادها';

  @override
  String get contractReviewsFreeFeature =>
      '۱ بررسی قرارداد (آزمایشی، یک‌بار مصرف)';

  @override
  String get contractReviewsCounselFeature => '۵ بررسی قرارداد در ماه';

  @override
  String get contractReviewsProFeature => '۲۰ بررسی قرارداد در ماه';
  ...
  String get contractReviewsExhausted =>
      'بررسی قراردادی برای این ماه باقی نمانده است';

  @override
  String get contractReviewsFreeTrialLeft =>
      'نسخه آزمایشی رایگان: ۱ بررسی قرارداد';

  @override
  String get contractReviewsFreeTrialUsed =>
      'نسخه آزمایشی رایگان استفاده شد — برای دریافت بیشتر ارتقا دهید';

  @override
  String get contractReviewsUpgradeTitle => 'بررسی‌های قرارداد به پایان رسید';

  @override
  String get contractReviewsUpgradeBodyFree =>
      'شما از بررسی رایگان قرارداد خود استفاده کردید. برای بررسی‌های ماهانه ارتقا دهید.';

  @override
  String contractReviewsUpgradeBodyPaid(int used, int cap) {
    return 'شما $used از $cap بررسی این ماه را استفاده کرده‌اید. برای سقف ماهانه بالاتر ارتقا دهید.';
  }

  @override
  String get contractReviewsUpgradeCounselCta =>
      'ارتقا به Counsel (۱۹.۹۹ یورو/ماه) — ۵ بررسی';

  @override
  String get contractReviewsUpgradeProCta =>
      'ارتقا به Pro (۲۹.۹۹ یورو/ماه) — ۲۰ بررسی';

  @override
  String get contractReviewsUpgradeToProShort => 'ارتقا به Pro — ۲۰ در ماه';
  ...
  @override
  String get checkerProTagline => 'ابزارهای حرفه‌ای تأیید صحت';

  @override
  String get checkerDataSource => 'داده از سامانه‌های رسمی ثبتی';

  @override
  String get companyCheckerHint => 'نام شرکت یا شماره ثبت';

  @override
  String get companyCheckerPriceChip =>
      '۲.۹۹ یورو در هر بررسی  •  شامل بسته Pro';

  @override
  String get companyCheckerEmptyState =>
      'برای دریافت گزارش کامل، نام شرکت یا\nشماره ثبت را وارد کنید';

  @override
  String get aiMemoryTitle => 'حافظه هوش مصنوعی';

  @override
  String get aiMemorySubtitle =>
      'آنچه هوش مصنوعی درباره شما به خاطر دارد را مرور و فراموش کنید';

  @override
  String get bookLawyerCallTitle => 'رزرو تماس با وکیل';

  @override
  String get bookLawyerCallComingSoonTitle =>
      'تماس با وکیل انسانی — به‌زودی فعال می‌شود';

  @override
  String get bookLawyerCallComingSoonBody =>
      'پلن‌های Pro و Premium شامل تماس‌های ۱۵ دقیقه‌ای با یک وکیل شریک هستند (۱ بار در فصل در Pro، ۲ بار در فصل در Premium). ما در حال نهایی‌کردن جمع وکلای مستقل استونی هستیم و به‌محض باز شدن رزرو، به شما ایمیل خواهیم زد.';

  @override
  String bookLawyerCallQuotaAvailable(int remaining, int total) {
    return 'شما $remaining از $total تماس باقی‌مانده در این فصل دارید.';
  }

  @override
  String get bookLawyerCallQuotaExhausted => 'سهمیه فصلی استفاده شد.';

  @override
  String get bookLawyerCallQuotaBodyAvailable =>
      'سطح Pro شامل ۱ تماس در فصل است، Premium ۲ تماس. تماس‌ها ۱۵ دقیقه از طریق Google Meet برگزار می‌شوند.';

  @override
  String get bookLawyerCallQuotaBodyExhausted =>
      'سهمیه شما در روز اول فصل بعدی بازنشانی می‌شود. نیاز به صحبت زودتر دارید؟ برای یک تماس اضافه به Premium ارتقا دهید.';

  @override
  String get severityCritical => 'حیاتی';

  @override
  String get severityHigh => 'بالا';

  @override
  String get severityMedium => 'متوسط';

  @override
  String get severityLow => 'پایین';

  @override
  String get deadlineRequiredFields => 'عنوان و تاریخ مهلت الزامی است';

  @override
  String get acceptTermsRequired => 'لطفاً با شرایط خدمات موافقت کنید';

  @override
  String get chatLegalCouncilTooltip => 'شورای حقوقی (۴ کارشناس)';

  @override
  String get attachFileTooltip => 'پیوست فایل';

  @override
  String get sendMessage => 'ارسال پیام';

  @override
  String get stopGenerating => 'توقف تولید';
  ...
  @override
  String get decreaseDependents => 'کاهش';

  @override
  String get increaseDependents => 'افزایش';
  ...
  @override
  String get draftsTab => 'پیش‌نویس‌ها';

  @override
  String get draftingTitle => 'استودیو تنظیم اسناد';

  @override
  String get draftingEmpty => 'پیش‌نویس خالی';

  @override
  String get draftingPlaceholder => 'نوشتن پیش‌نویس خود را آغاز کنید…';

  @override
  String get draftingDraftsList => 'پیش‌نویس‌های من';

  @override
  String get draftingSave => 'ذخیره';

  @override
  String get draftingSaved => 'ذخیره شد';

  @override
  String get draftingSavedJustNow => 'همین الان ذخیره شد';

  @override
  String get draftingAiRevise => 'بازبینی با هوش مصنوعی';

  @override
  String get draftingExportPdf => 'خروجی PDF';

  @override
  String get draftingExportDocx => 'خروجی DOCX';

  @override
  String get draftingExportMd => 'خروجی Markdown';

  @override
  String get draftingDeleteDraft => 'حذف پیش‌نویس';

  @override
  String get draftingConfirmDelete => 'این پیش‌نویس حذف شود؟';

  @override
  String get draftingConfirmDeleteMessage => 'این عمل قابل بازگشت نیست.';

  @override
  String get draftingConfirm => 'حذف';

  @override
  String get draftingCancel => 'لغو';
  ...
  @override
  String get draftingUntitled => 'بدون عنوان';

  @override
  String get draftingTitleHint => 'عنوان (اختیاری)';

  @override
  String get draftingAiReviseTitle => 'بازبینی با هوش مصنوعی';

  @override
  String get draftingAiReviseSelectionLabel => 'متن انتخاب‌شده:';

  @override
  String get draftingAiReviseInstructionLabel => 'دستورالعمل (اختیاری)';

  @override
  String get draftingAiReviseInstructionHint =>
      'مثلاً «رسمی‌تر کن» یا «کوتاه‌تر کن»';

  @override
  String get draftingAiReviseRunButton => 'تولید بازبینی';

  @override
  String get draftingAiReviseSuggestionLabel => 'بازبینی پیشنهادی:';

  @override
  String get draftingAiReviseChangesLabel => 'تغییرات:';

  @override
  String get draftingAiReviseAccept => 'پذیرفتن';

  @override
  String get draftingAiReviseReject => 'رد کردن';

  @override
  String get draftingFormatBold => 'پررنگ';

  @override
  String get draftingFormatItalic => 'کج';

  @override
  String get draftingFormatHeading => 'سرتیتر';

  @override
  String get draftingFormatBullet => 'فهرست نقطه‌ای';

  @override
  String get draftingFormatNumbered => 'فهرست شماره‌دار';

  @override
  String get draftingEmptyListMessage => 'شما هنوز پیش‌نویسی ندارید.';

  @override
  String get draftingEmptyListAction => 'پیش‌نویس جدید';

  @override
  String get draftingExporting => 'در حال خروجی‌گیری…';

  @override
  String get draftingExportFailed => 'خروجی‌گیری ناموفق بود';

  @override
  String get draftingSaveFailed => 'ذخیره ناموفق بود';

  @override
  String get draftingNewDraft => 'پیش‌نویس جدید';

  @override
  String get vaultNoteChip => 'یادداشت خزانه';

  @override
  String get saveToVault => 'ذخیره در خزانه';

  @override
  String get savingToVault => 'در حال ذخیره در خزانه…';

  @override
  String get savedToVault => 'در خزانه ذخیره شد';

  @override
  String get vaultNoteTitlePrefix => 'یادداشت: ';

  @override
  String get openInVault => 'باز کردن در خزانه';

  @override
  String get saveToVaultFailed => 'ذخیره در خزانه ناموفق بود';

  @override
  String get pdfWorkerUnavailable =>
      'خروجی PDF موقتاً در دسترس نیست. لطفاً DOCX یا Markdown را امتحان کنید.';

  @override
  String get draftingVersionHistory => 'تاریخچه نسخه‌ها';

  @override
  String get emptyHomeTitle => 'به Advocat خوش آمدید';

  @override
  String get emptyHomeBody =>
      'یک نقطه شروع انتخاب کنید — ما بار سنگین حقوقی را به دوش می‌کشیم.';

  @override
  String get intentChip1 => 'جریمه گرفته‌ام';

  @override
  String get intentChip2 => 'درخواست اقامتم رد شد';

  @override
  String get intentChip3 => 'مشکل قراردادی دارم';

  @override
  String get emptyCasesTitle => 'هنوز پرونده‌ای وجود ندارد';

  @override
  String get emptyCasesCta => 'شروع یک پرونده';

  @override
  String get emptyDraftsTitle => 'هنوز پیش‌نویسی وجود ندارد';

  @override
  String get emptyDraftsCta => 'ایجاد پیش‌نویس';

  @override
  String get emptyChatTitle => 'هر چیزی از Advocat بپرسید';

  @override
  String get chatExamplePrompt1 => 'به من در پاسخ به یک جریمه کمک کن';

  @override
  String get chatExamplePrompt2 => 'قرارداد اجاره من را بررسی کن';
  ...
  @override
  String get contractReviewUploadCta => 'بارگذاری قرارداد';

  @override
  String get contractReviewQuotaRemaining =>
      'یک قرارداد PDF، DOC، DOCX یا TXT برای بررسی هوش مصنوعی با هشدارهای حقوقی و نکات مذاکره بارگذاری کنید.';

  @override
  String get contractReviewRedFlags => 'هشدارهای حقوقی';

  @override
  String get contractReviewReviewPoints => 'نکات بررسی';

  @override
  String get contractReviewNegotiationTips => 'نکات مذاکره';

  @override
  String get contractReviewSaveToVault => 'ذخیره در خزانه';

  @override
  String get contractReviewContinueChat => 'ادامه در گفتگو';

  @override
  String get referralInviteFriends => 'دعوت از دوستان';

  @override
  String get referralYourCode => 'کد شما';

  @override
  String get referralCopiedToast => 'کد در کلیپ‌بورد کپی شد';

  @override
  String get referralReward =>
      'برای هر دوستی که مشترک شود، ۱ ماه Counsel رایگان دریافت کنید.';

  @override
  String get referralInvited => 'دوستان دعوت‌شده';

  @override
  String get referralRewardsEarned => 'ماه‌های رایگان کسب‌شده';

  @override
  String get deadlineUrgencyToday => 'امروز و سررسیدگذشته';

  @override
  String get deadlineUrgencyWeek => 'این هفته';

  @override
  String get deadlineUrgencyMonth => 'این ماه';

  @override
  String get deadlineUrgencyLater => 'بعداً';

  @override
  String get deadlineAddManual => 'افزودن مهلت';

  @override
  String get deadlineSnoozeBy => 'به تعویق انداختن';

  @override
  String get deadlineSnooze1d => '۱ روز به تعویق بیفتد';

  @override
  String get deadlineSnooze3d => '۳ روز به تعویق بیفتد';

  @override
  String get deadlineSnooze7d => '۷ روز به تعویق بیفتد';

  @override
  String get deadlineDismiss => 'بستن';

  @override
  String get deadlineExportIcs => 'افزودن به تقویم';

  @override
  String get deadlineSource => 'منبع';

  @override
  String get deadlineEmpty =>
      'هنوز مهلتی وجود ندارد. مهلت‌ها به‌طور خودکار از ایمیل‌ها و مدارک شما ساخته می‌شوند — یا با دکمه + یکی را به‌صورت دستی اضافه کنید.';

  @override
  String get deadlineNewTitle => 'مهلت جدید';

  @override
  String get deadlineFieldTitle => 'عنوان';

  @override
  String get deadlineFieldDueDate => 'تاریخ سررسید';

  @override
  String get deadlineFieldNotes => 'یادداشت‌ها (اختیاری)';

  @override
  String get deadlineSaved => 'مهلت ذخیره شد';

  @override
  String get deadlineSaveFailed => 'ذخیره مهلت ممکن نشد';

  @override
  String get deadlineUrgentBannerSingle => '۱ مهلت امروز یا سررسیدگذشته';

  @override
  String deadlineUrgentBannerMany(int count) {
    return '$count مهلت امروز یا سررسیدگذشته';
  }
  ...
  String deadlineDaysOverdue(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count روز از سررسید گذشته',
      one: '۱ روز از سررسید گذشته',
    );
    return '$_temp0';
  }
  ...
  @override
  String get deadlineEuRadarTitle => 'رادار مهلت‌های اتحادیه اروپا (پیش‌نمایش)';

  @override
  String get deadlineEuRadarSubtitle =>
      'مهلت‌های فرضی رویه‌ای اتحادیه اروپا — داده آزمایشی';
  ...
  @override
  String get accessLogTile => 'گزارش دسترسی';

  @override
  String get accessLogTileSubtitle =>
      'ببینید چه کسی و چه چیزی به داده‌های شما دسترسی داشته است';

  @override
  String get accessLogTitle => 'گزارش دسترسی به داده‌های من';

  @override
  String get accessLogIntro =>
      'سابقه‌ای شفاف و دستکاری‌ناپذیر از هر بار که به داده‌های شما دسترسی یا پردازش انجام شده است — از جمله توسط هوش مصنوعی ما. می‌توانید تأیید کنید که این سابقه تغییر نکرده است.';

  @override
  String get accessLogEmpty => 'هنوز هیچ رویداد دسترسی ثبت نشده است.';

  @override
  String get accessLogError =>
      'بارگذاری گزارش دسترسی شما ممکن نشد. برای تلاش مجدد به پایین بکشید.';

  @override
  String get accessLogIntegrityOk =>
      'یکپارچگی تأیید شد — پیوندهای گزارش زنجیره‌ای پیوسته را تشکیل می‌دهند.';

  @override
  String get accessLogIntegrityBroken =>
      'هشدار: زنجیره گزارش شکسته است. ممکن است برخی موارد حذف یا جابجا شده باشند. لطفاً با پشتیبانی تماس بگیرید.';

  @override
  String get accessActionLlmEgress =>
      'برای پردازش به هوش مصنوعی ارسال شد (نام‌زدایی‌شده)';

  @override
  String get accessActionAiAnalysis => 'توسط هوش مصنوعی تحلیل شد';

  @override
  String get accessActionDocumentParse => 'سند تجزیه شد';

  @override
  String get accessActionStaffRead => 'توسط یکی از کارکنان بررسی شد';

  @override
  String get accessActionExport => 'داده‌ها برون‌بری شد';

  @override
  String get accessActionEmailTriage => 'ایمیل دسته‌بندی شد';

  @override
  String get accessActionDeadlineScan => 'مهلت‌ها بررسی شدند';

  @override
  String get breachAlertTitle => 'هشدار امنیتی درباره داده‌های شما';

  @override
  String get breachAlertBody =>
      'پایش خودکار ما دسترسی غیرعادی به داده‌های شما را شناسایی کرد. ما در حال بررسی آن هستیم و در صورت تأیید هرگونه حادثه، مطابق قانون (ماده ۳۴ GDPR) به شما اطلاع خواهیم داد.';

  @override
  String get caseDossierTitle => 'برون‌بری پرونده کامل';

  @override
  String get caseDossierSubtitle =>
      'یک فایل PDF با همه چیز — حقایق، گاه‌شماری، مهلت‌ها و اسناد — برای ارائه به وکیل، دادگاه یا مرجع شکایت.';

  @override
  String get caseDossierTileTitle => 'برون‌بری پرونده (PDF)';

  @override
  String get caseDossierTileSubtitle =>
      'کل پرونده را در یک فایل به وکیل یا دادگاه تحویل دهید';

  @override
  String get caseDossierSectionsHeading => 'موارد قابل درج در پرونده';

  @override
  String get caseDossierSectionFacts => 'حقایق پرونده';

  @override
  String get caseDossierSectionFactsHint => 'همیشه درج می‌شود';

  @override
  String get caseDossierSectionTimeline => 'گاه‌شماری';

  @override
  String get caseDossierSectionDeadlines => 'مهلت‌ها';

  @override
  String get caseDossierSectionDocuments => 'اسناد';

  @override
  String get caseDossierSectionAiSummary => 'خلاصه هوش مصنوعی';

  @override
  String get caseDossierExportButton => 'برون‌بری PDF';

  @override
  String get caseDossierExporting => 'در حال ساخت پرونده شما…';

  @override
  String get caseDossierSuccess =>
      'پرونده آماده است. فایل را باز کنید یا به اشتراک بگذارید.';

  @override
  String get caseDossierOpen => 'باز کردن پرونده';

  @override
  String get caseDossierError =>
      'ساخت پرونده ممکن نشد. لطفاً دوباره تلاش کنید.';

  @override
  String get caseDossierErrorNotOwned => 'این پرونده یافت نشد.';

  @override
  String get caseDossierDisclaimer =>
      'این پرونده داده‌های شما را همان‌گونه که ثبت شده بازتولید می‌کند. پیش از اشتراک‌گذاری آن را بررسی کنید.';

  @override
  String get followupsTitle => 'گام‌های بعدی';

  @override
  String get followupsSubtitle => 'وظایف عملی برای پیشبرد پرونده شما';

  @override
  String get followupsEmpty => 'هنوز هیچ گام پیگیری وجود ندارد.';

  @override
  String get followupsEmptyDesc =>
      'گامی اضافه کنید، یا بگذارید هوش مصنوعی اقدام بعدی را پیشنهاد دهد.';

  @override
  String get followupsAdd => 'افزودن گام';

  @override
  String get followupsSuggest => 'پیشنهاد گام‌ها';

  @override
  String get followupsSuggestNone =>
      'در حال حاضر پیشنهادی نیست. پس از گفتگو درباره پرونده دوباره امتحان کنید.';

  @override
  String get followupsSuggestTitle => 'گام‌های بعدی پیشنهادی';

  @override
  String get followupsAddPrompt =>
      'گام‌هایی را که می‌خواهید نگه دارید اضافه کنید:';

  @override
  String get followupsNewTitleHint => 'چه کاری باید انجام شود؟';

  @override
  String get followupsNewDetailHint =>
      'یادداشت اختیاری (چرا / چه چیزی پیوست شود)';

  @override
  String get followupsDueOptional => 'به من یادآوری کن در (اختیاری)';

  @override
  String get followupsOverdue => 'گذشته از مهلت';
  ...
  @override
  String get followupsDone => 'انجام شد';

  @override
  String get followupsSnooze => 'به تعویق انداختن';

  @override
  String get followupsSnooze1Week => 'یک هفته دیگر یادآوری کن';

  @override
  String get followupsDismiss => 'نادیده گرفتن';

  @override
  String get followupsLoadError => 'بارگذاری گام‌های بعدی ممکن نشد';

  @override
  String get followupsAiBadge => 'هوش مصنوعی';

  @override
  String get contractCompareTitle => 'مقایسه نسخه‌ها';

  @override
  String get contractCompareIntro =>
      'دو نسخه از یک قرارداد را بارگذاری کنید. ما تغییرات را برجسته می‌کنیم و نشان می‌دهیم که هر تغییر به نفع شماست یا به ضرر شما.';

  @override
  String get contractCompareOldVersion => 'نسخه قدیمی (v1)';

  @override
  String get contractCompareNewVersion => 'نسخه جدید (v2)';

  @override
  String get contractCompareCta => 'مقایسه نسخه‌ها';

  @override
  String get contractCompareAdverse => 'نامساعد';

  @override
  String get contractCompareFavorable => 'مساعد';

  @override
  String get contractCompareNeutral => 'خنثی';

  @override
  String get contractCompareBefore => 'پیش از';

  @override
  String get contractCompareAfter => 'پس از';

  @override
  String get contractCompareTruncated =>
      'قرارداد طولانی — تنها بخش نخست هر نسخه مقایسه شد.';

  @override
  String get contractCompareNoChanges =>
      'هیچ تغییر اساسی میان دو نسخه شناسایی نشد.';

  @override
  String get docSearchTitle => 'جستجو در اسناد من';

  @override
  String get docSearchHint => 'مثلاً جایی که ودیعه ذکر شده بود';

  @override
  String get docSearchSubtitle => 'جستجوی معنایی در گاوصندوق و پرونده‌های شما';

  @override
  String get docSearchIdle =>
      'محتوای اسناد خود را جستجو کنید — نه فقط عنوان‌ها.';

  @override
  String get docSearchNoResults => 'هیچ تطابقی در اسناد شما یافت نشد.';

  @override
  String get docSearchError => 'جستجو ناموفق بود. لطفاً دوباره تلاش کنید.';

  @override
  String get docSearchUntitled => 'سند بدون عنوان';

  @override
  String get docSearchKindCase => 'سند پرونده';

  @override
  String get docSearchKindVault => 'سند گاوصندوق';

  @override
  String get docSearchMenuTitle => 'جستجو در اسناد من';

  @override
  String get docSearchMenuSubtitle =>
      'هر چیزی را در فایل‌های خود بر اساس معنا بیابید';

  @override
  String get legalTemplatesTitle => 'کتابخانه قالب‌ها';

  @override
  String get legalTemplatesMenuLabel => 'قالب‌ها';

  @override
  String get legalTemplatesSubtitle =>
      'یک فرم آماده انتخاب کنید، چند مورد را پر کنید، و ما پیش‌نویسی می‌سازیم که می‌توانید ویرایش و برون‌بری کنید.';

  @override
  String get legalTemplatesDisclaimer =>
      'این‌ها فرم‌های نمونه عمومی هستند، نه مشاوره حقوقی فردی. پیش از ارسال بررسی و تطبیق دهید.';

  @override
  String get legalTemplatesSampleBadge => 'نمونه';

  @override
  String get legalTemplatesEmpty => 'هنوز قالبی برای این فیلتر وجود ندارد.';

  @override
  String get legalTemplatesError =>
      'بارگذاری قالب‌ها ممکن نشد. لطفاً دوباره تلاش کنید.';

  @override
  String get legalTemplatesFilterAll => 'همه';

  @override
  String get legalTemplatesJurisdictionFi => 'فنلاند';

  @override
  String get legalTemplatesJurisdictionEe => 'استونی';

  @override
  String get legalTemplatesCategoryComplaint => 'شکایت‌ها';

  @override
  String get legalTemplatesCategoryAppeal => 'تجدیدنظرها';

  @override
  String get legalTemplatesCategoryApplication => 'درخواست‌ها';

  @override
  String get legalTemplatesCategoryClaim => 'دعاوی';

  @override
  String get legalTemplatesCategoryRequest => 'تقاضاها';

  @override
  String get legalTemplatesFillTitle => 'جزئیات را پر کنید';

  @override
  String get legalTemplatesFillIntro =>
      'ما نام و جزئیات پرونده شما را به‌طور خودکار پر می‌کنیم. فیلدهای زیر را تکمیل کنید.';

  @override
  String get legalTemplatesFieldRequired => 'این فیلد الزامی است';

  @override
  String get legalTemplatesCreateDraft => 'ساخت پیش‌نویس';

  @override
  String get legalTemplatesCreating => 'در حال ساخت پیش‌نویس…';

  @override
  String get legalTemplatesCreateFailed =>
      'ساخت پیش‌نویس ممکن نشد. لطفاً دوباره تلاش کنید.';

  @override
  String get legalTemplatesUnresolvedWarning =>
      'برخی فیلدها هنوز خالی‌اند و در پیش‌نویس با ____ مشخص شده‌اند. می‌توانید آن‌ها را در ویرایشگر تکمیل کنید.';

  @override
  String get legalTemplatesFieldRecipient => 'گیرنده (مرجع / موجر)';

  @override
  String get legalTemplatesFieldAddress => 'نشانی پستی شما';

  @override
  String get legalTemplatesFieldSubject => 'موضوع';

  @override
  String get legalTemplatesFieldDescription => 'شرح موضوع';

  @override
  String get legalTemplatesFieldDemand => 'آنچه درخواست می‌کنید';

  @override
  String get checklistActionPlan => 'برنامه اقدام';

  @override
  String get checklistActionPlanSubtitle => 'گام‌های این نوع پرونده';

  @override
  String checklistProgress(int completed, int total) {
    return '$completed از $total گام انجام شد';
  }

  @override
  String get checklistAllDone => 'همه گام‌ها کامل شد';

  @override
  String get checklistEmpty =>
      'هنوز برنامه اقدامی برای این نوع پرونده در دسترس نیست.';
  ...
  String get checklistDisclaimer =>
      'این اطلاعات عمومی است، نه مشاوره حقوقی. مهلت‌ها مقادیر پیش‌فرض قانونی هستند — تاریخ دقیق پرونده خود را تأیید کنید.';

  @override
  String get checklistViewPlan => 'مشاهده برنامه';

  @override
  String get explainPlainTitle => 'توضیح به زبان ساده';

  @override
  String get explainPlainIntro =>
      'یک نامه رسمی، تصمیم یا قرارداد را جای‌گذاری کنید و ما به زبان ساده توضیح می‌دهیم که معنای آن چیست و از شما چه می‌خواهد.';

  @override
  String get explainPlainLevelFriend => 'مثل گفتن به یک دوست';

  @override
  String get explainPlainLevelTerms => 'حفظ اصطلاحات حقوقی';

  @override
  String get explainPlainInputHint => 'متن حقوقی را اینجا جای‌گذاری کنید…';

  @override
  String get explainPlainSubmit => 'توضیح بده';

  @override
  String get explainPlainWorking => 'در حال توضیح…';

  @override
  String get explainPlainTldr => 'جمع‌بندی';

  @override
  String get explainPlainBreakdown => 'آنچه می‌گوید، بخش به بخش';

  @override
  String get explainPlainGlossary => 'اصطلاحات دشوار توضیح‌داده‌شده';

  @override
  String get explainPlainNextSteps => 'کاری که می‌توانید بعد انجام دهید';

  @override
  String get explainPlainOpenInCorpus => 'جستجو در کتابخانه قوانین';

  @override
  String get explainPlainEmptyResult =>
      'توضیحی برای این متن تولید نشد. متن طولانی‌تر یا روشن‌تری را جای‌گذاری کنید.';

  @override
  String get explainPlainQuotaTitle =>
      'شما توضیحات رایگان این ماه خود را استفاده کرده‌اید';

  @override
  String get explainPlainQuotaBody =>
      'حساب‌های رایگان ماهانه ۳ توضیح دریافت می‌کنند. برای توضیحات نامحدود به Pro ارتقا دهید.';

  @override
  String get explainPlainUpgradeCta => 'ارتقا به Pro';

  @override
  String get explainPlainError =>
      'هنگام توضیح این متن خطایی رخ داد. لطفاً دوباره تلاش کنید.';

  @override
  String get explainPlainRetry => 'تلاش مجدد';

  @override
  String get demandLetterTitle => 'نامه مطالبه';

  @override
  String get demandLetterSubtitle =>
      'یک مطالبه رسمی پیش از دادگاه ایجاد کنید (maksuvaatimus / nõudekiri).';

  @override
  String get demandLetterStepType => 'نوع دعوا';

  @override
  String get demandLetterStepParties => 'طرفین';

  @override
  String get demandLetterStepClaim => 'مبلغ و مبنا';

  @override
  String get demandLetterStepDeadline => 'مهلت';

  @override
  String get demandLetterStepReview => 'بررسی و تولید';

  @override
  String get demandLetterClaimDepositReturn => 'بازگشت ودیعه اجاره';

  @override
  String get demandLetterClaimUnpaidWage => 'دستمزد پرداخت‌نشده';

  @override
  String get demandLetterClaimFineDispute => 'اعتراض به جریمه / هزینه';

  @override
  String get demandLetterClaimGeneric => 'سایر دعاوی مالی';

  @override
  String get demandLetterJurisdiction => 'حوزه قضایی';

  @override
  String get demandLetterLanguage => 'زبان نامه';

  @override
  String get demandLetterRecipientName => 'نام گیرنده';

  @override
  String get demandLetterRecipientAddress => 'نشانی گیرنده (اختیاری)';

  @override
  String get demandLetterSenderName => 'نام شما';

  @override
  String get demandLetterSenderAddress => 'نشانی / ایمیل شما (اختیاری)';

  @override
  String get demandLetterAmount => 'مبلغ';

  @override
  String get demandLetterCurrency => 'واحد پول';

  @override
  String get demandLetterBasis => 'آنچه رخ داد (مبنای دعوا)';

  @override
  String get demandLetterBasisHint =>
      'حقایق را شرح دهید: تاریخ‌ها، مبالغ، آنچه توافق شده و آنچه اشتباه پیش رفته است.';

  @override
  String get demandLetterDeadline => 'مهلت پرداخت';

  @override
  String get demandLetterDeadlineHint => 'مثلاً ۱۴ روز از امروز';

  @override
  String get demandLetterReference => 'شماره مرجع (اختیاری)';

  @override
  String get demandLetterGenerate => 'تولید نامه';

  @override
  String get demandLetterGenerating => 'در حال تولید…';

  @override
  String get demandLetterGenerateFailed =>
      'تولید نامه ممکن نشد. لطفاً دوباره تلاش کنید.';

  @override
  String get demandLetterFieldRequired => 'این فیلد الزامی است';

  @override
  String get demandLetterNext => 'بعدی';

  @override
  String get demandLetterBack => 'بازگشت';

  @override
  String get demandLetterPreviewTitle => 'نامه شما';

  @override
  String get demandLetterCopy => 'کپی متن';

  @override
  String get demandLetterCopied => 'نامه در کلیپ‌بورد کپی شد';

  @override
  String get demandLetterExportPdf => 'برون‌بری PDF';

  @override
  String get demandLetterExporting => 'در حال برون‌بری…';

  @override
  String get demandLetterExportFailed =>
      'برون‌بری سند ممکن نشد. لطفاً دوباره تلاش کنید.';

  @override
  String get demandLetterSendEmail => 'ارسال از طریق ایمیل';

  @override
  String get demandLetterNormsTitle => 'ارجاعات حقوقی';

  @override
  String get demandLetterDisclaimer =>
      'این نامه به‌عنوان یک قالب عمومی از طرف شما تهیه شده است. این مشاوره حقوقی یا اقدام یک وکیل پروانه‌دار نیست. پیش از ارسال آن را بررسی کنید — هیچ نامه‌ای به‌طور خودکار ارسال نمی‌شود.';

  @override
  String get demandLetterMenuTile => 'نامه مطالبه';

  @override
  String get calcHubTitle => 'ماشین‌حساب‌های حقوقی';

  @override
  String get calcHubSubtitle => 'برآوردهای سریع پیش از گام بعدی شما';

  @override
  String get calcHubJurisdiction => 'حوزه قضایی';

  @override
  String calcRatesAsOf(String date) {
    return 'نرخ‌ها به تاریخ $date';
  }

  @override
  String get calcRatesOffline => 'نمایش نرخ‌های ذخیره‌شده (آفلاین)';

  @override
  String get calcIndicativeBanner =>
      'تنها برآورد تقریبی — نه محاسبه رسمی و نه مشاوره حقوقی.';

  @override
  String get calcCalculate => 'محاسبه';

  @override
  String get calcResult => 'نتیجه';

  @override
  String get calcFormula => 'نحوه محاسبه این مقدار';

  @override
  String get calcSource => 'منبع';

  @override
  String get calcSeveranceTitle => 'حق سنوات / اخطار';

  @override
  String get calcSeveranceDesc => 'برآورد حق سنوات و دوره اخطار در تعدیل نیرو';

  @override
  String get calcSeveranceSalary => 'حقوق ناخالص ماهانه';

  @override
  String get calcSeveranceTenure => 'سال‌های خدمت';

  @override
  String get calcSeveranceTotal => 'حق سنوات برآوردی';

  @override
  String get calcSeveranceNotice => 'دوره اخطار';

  @override
  String get calcSeveranceGenerateDemand => 'تهیه نامه مطالبه';

  @override
  String get calcLimitationTitle => 'مهلت‌های مرور زمان و تجدیدنظر';

  @override
  String get calcLimitationDesc =>
      'بررسی کنید که آیا مهلت دعوا یا تجدیدنظر منقضی شده است';

  @override
  String get calcLimitationType => 'نوع مهلت';

  @override
  String get calcLimitationStart => 'تاریخ شروع (رویداد / تصمیم)';

  @override
  String get calcLimitationPickDate => 'انتخاب تاریخ';

  @override
  String get calcLimitationDeadline => 'مهلت';

  @override
  String get calcLimitationExpired => 'مهلت منقضی شده است';
  ...
  String get calcLimitationShifted =>
      'به روز کاری بعد منتقل شد (آخر هفته/تعطیل).';

  @override
  String get calcLimitationAddDeadline => 'افزودن به مهلت‌ها';

  @override
  String get calcStateFeeTitle => 'هزینه‌های دادگاه / دولتی';

  @override
  String get calcStateFeeDesc =>
      'هزینه‌های مرجع ثبت دادخواست بر اساس دادگاه و مرحله';

  @override
  String get calcChildSupportTitle => 'نفقه فرزند (تقریبی)';

  @override
  String get calcChildSupportDesc =>
      'رقم تقریبی برای جهت‌گیری — مبلغ واقعی موردبه‌مورد تعیین می‌شود';

  @override
  String get calcChildSupportNet => 'درآمد خالص ماهانه پرداخت‌کننده';

  @override
  String get calcChildSupportChildren => 'تعداد فرزندان';

  @override
  String get calcChildSupportPerChild => 'به ازای هر فرزند';

  @override
  String get calcChildSupportTotal => 'مجموع ماهانه';

  @override
  String get calcChildSupportWarning =>
      'بسیار متغیر است. دادگاه‌ها بر اساس نیازهای فرزند و توان پرداخت هر دو والد تصمیم می‌گیرند. تنها به‌عنوان نقطه شروع استفاده کنید.';

  @override
  String get docCollectTitle => 'اسنادی که باید گردآوری شوند';

  @override
  String get docCollectSubtitle =>
      'این‌ها را پیش از درخواست یا مراجعه به دادگاه گردآوری کنید';

  @override
  String get docCollectPickPrompt => 'وضعیت شما چیست؟';

  @override
  String get docCollectProblemResidence => 'اجازه اقامت';

  @override
  String get docCollectProblemTenant => 'اجاره‌نشینی / تخلیه';

  @override
  String get docCollectProblemDismissal => 'اخراج از کار';

  @override
  String get docCollectProblemInheritance => 'ارث';

  @override
  String get docCollectProblemDivorce => 'طلاق';

  @override
  String docCollectProgress(int collected, int total) {
    return '$collected از $total گردآوری شد';
  }

  @override
  String get docCollectAllDone => 'همه چیز گردآوری شد';

  @override
  String get docCollectEmpty =>
      'هنوز فهرست اسنادی برای این وضعیت در دسترس نیست.';

  @override
  String get docCollectOptional => 'اختیاری';

  @override
  String get docCollectWhereLabel => 'محل تهیه';

  @override
  String get docCollectWhyLabel => 'چرا لازم است';

  @override
  String get docCollectAttach => 'پیوست فایل';

  @override
  String get docCollectAttached => 'فایل پیوست شد';

  @override
  String get docCollectChangeFile => 'تغییر فایل';

  @override
  String get docCollectRemoveFile => 'حذف فایل';

  @override
  String get docCollectNoFiles => 'شما هنوز هیچ سندی بارگذاری نکرده‌اید.';

  @override
  String get docCollectPickFileTitle => 'یک سند بارگذاری‌شده انتخاب کنید';

  @override
  String get docCollectExport => 'برون‌بری فهرست';

  @override
  String get docCollectExportSubject => 'فهرست اسناد من';

  @override
  String get docCollectAiTitle => 'به چیز خاصی نیاز دارید؟';

  @override
  String get docCollectAiHint =>
      'وضعیت خود را شرح دهید و ما اسناد اضافی را پیشنهاد می‌دهیم.';

  @override
  String get docCollectAiField => 'وضعیت خود را شرح دهید';

  @override
  String get docCollectAiButton => 'پیشنهاد اسناد اضافی';

  @override
  String get docCollectAiLoading => 'در حال فکر کردن…';

  @override
  String get docCollectAiEmpty =>
      'سند اضافی پیشنهاد نشد — فهرست پایه برای شرح شما کامل به نظر می‌رسد.';

  @override
  String get docCollectAiSuggestionsTitle => 'اسناد اضافی پیشنهادی';

  @override
  String get docCollectDisclaimer =>
      'این یک فهرست پایه از اسناد رایج موردنیاز است — وضعیت شما ممکن است به اسناد بیشتر یا کمتری نیاز داشته باشد. این اطلاعات عمومی است، نه مشاوره حقوقی.';

  @override
  String get docCollectRetry => 'تلاش مجدد';

  @override
  String get renewalTitle => 'رادار تمدید';

  @override
  String get renewalSubtitle =>
      'پیگیری کنید که اجازه‌ها، گذرنامه، بیمه و سایر اسناد شما چه زمانی منقضی می‌شوند. ما ۹۰، ۳۰ و ۷ روز پیش از هر تمدید به شما یادآوری می‌کنیم.';

  @override
  String get renewalAdd => 'افزودن سند';

  @override
  String get renewalEditTitle => 'ویرایش سند';

  @override
  String get renewalSave => 'ذخیره';

  @override
  String get renewalRequired => 'الزامی';

  @override
  String get renewalPickDate => 'انتخاب تاریخ انقضا';

  @override
  String get renewalLoadError =>
      'بارگذاری اسناد شما ممکن نشد. برای تازه‌سازی بکشید.';

  @override
  String get renewalEmptyTitle => 'هنوز سندی پیگیری نمی‌شود';

  @override
  String get renewalEmptyBody =>
      'اجازه اقامت، گذرنامه، بیمه یا گواهی‌نامه خود را اضافه کنید و ما تاریخ انقضا را برای شما زیر نظر می‌گیریم.';

  @override
  String get renewalGuideHint => 'نحوه تمدید ←';

  @override
  String get renewalFieldType => 'نوع سند';

  @override
  String get renewalFieldLabel => 'برچسب';

  @override
  String get renewalFieldNumber => 'شماره سند (اختیاری)';

  @override
  String get renewalFieldJurisdiction => 'کشور صادرکننده';

  @override
  String get renewalFieldExpiry => 'تاریخ انقضا';

  @override
  String get renewalWindow90 => '۹۰ روز';

  @override
  String get renewalWindow30 => '۳۰ روز';

  @override
  String get renewalWindow7 => '۷ روز';

  @override
  String get renewalExpiresToday => 'امروز منقضی می‌شود';

  @override
  String renewalExpiresInDays(int days, String date) {
    return 'انقضا تا $days روز دیگر · $date';
  }

  @override
  String renewalExpiredOn(String date) {
    return 'منقضی شده در $date';
  }

  @override
  String get renewalTypeResidencePermit => 'اجازه اقامت';

  @override
  String get renewalTypePassport => 'گذرنامه';

  @override
  String get renewalTypeIdCard => 'کارت شناسایی';

  @override
  String get renewalTypeVisa => 'روادید';

  @override
  String get renewalTypeDrivingLicence => 'گواهی‌نامه رانندگی';

  @override
  String get renewalTypeInsurance => 'بیمه';

  @override
  String get renewalTypeWorkPermit => 'اجازه کار';

  @override
  String get renewalTypeOther => 'سایر';

  @override
  String get costEstimateTitle => 'برآوردگر هزینه و ریسک';

  @override
  String get costEstimateSubtitle =>
      'تصوری تقریبی از هزینه احتمالی یک پرونده، مدت‌زمان آن و اینکه آیا ارزش پیگیری دارد به دست آورید.';

  @override
  String get costEstimateCaseTypeLabel => 'نوع پرونده';

  @override
  String get costEstimateCaseTypeHint =>
      'مثلاً فاکتور پرداخت‌نشده، اخراج غیرقانونی، اختلاف بر سر ودیعه';

  @override
  String get costEstimateJurisdictionLabel => 'حوزه قضایی';

  @override
  String get costEstimateAmountLabel => 'مبلغ مورد اختلاف (اختیاری)';

  @override
  String get costEstimateAmountHint => 'مثلاً ۱۲۵۰۰';

  @override
  String get costEstimateDescriptionLabel =>
      'وضعیت را به‌طور خلاصه شرح دهید (اختیاری)';

  @override
  String get costEstimateB2bToggle => 'کارت ارزیابی سرنخ (B2B)';

  @override
  String get costEstimateB2bSubtitle =>
      'خروجی فشرده برای دسته‌بندی سریع یک مشتری ورودی.';

  @override
  String get costEstimateSubmit => 'پرونده من را برآورد کن';

  @override
  String get costEstimateDisclaimer =>
      'تنها برآورد تقریبی — نه پیش‌بینی، نه تضمین و نه مشاوره حقوقی. هزینه‌ها و نتایج واقعی موردبه‌مورد متفاوت است.';

  @override
  String get costEstimateCostsHeading => 'هزینه‌های برآوردی';

  @override
  String get costEstimateCourtFee => 'هزینه دادگاه / دولتی';

  @override
  String get costEstimateLawyerFee => 'حق‌الوکاله';

  @override
  String get costEstimateTotal => 'مجموع (تقریبی)';

  @override
  String get costEstimateDuration => 'زمان تا نخستین رأی';

  @override
  String get costEstimateMonthsSuffix => 'ماه';

  @override
  String get costEstimateFactorsFor => 'به نفع شما';

  @override
  String get costEstimateFactorsAgainst => 'به ضرر شما';

  @override
  String get costEstimateStrengthWorth => 'احتمالاً ارزش پیگیری دارد';

  @override
  String get costEstimateStrengthContested =>
      'محل اختلاف — می‌تواند به هر سو برود';
