...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get appTitle => 'Advocat — Юридический информационный инструмент';

  @override
  String get onboardingTitle1 => 'Юридическая информация на основе ИИ';

  @override
  String get onboardingDesc1 =>
      'Advocat помогает вам разобраться в вашей юридической ситуации. ИИ анализирует документы, выявляет возможные проблемы и подготавливает черновики документов для вашей проверки. Это не юридическая фирма — это технологический инструмент для поддержки вашего дела.';
  ...
  String get onboardingDesc2 =>
      'Сфотографируйте любой юридический документ. ИИ прочитает его на нескольких языках, извлечёт ключевые детали и проверит на соответствие директивам ЕС и национальному законодательству.';

  @override
  String get onboardingTitle3 => 'ИИ проверяет возможные нарушения';

  @override
  String get onboardingDesc3 =>
      'Наши ИИ-инструменты проверяют 40+ видов процессуальных требований. Анализ может выявить вопросы, требующие внимания — язык вручения, процессуальные нормы и сроки. Всегда проверяйте результаты у квалифицированного юриста.';
  ...
  String get onboardingDesc4 =>
      'ИИ подготавливает черновики жалоб, заявлений и писем со ссылками на законодательство. Вы решаете, что подавать. Каждый документ рекомендуется проверить у квалифицированного юриста перед подачей.';
  ...
  @override
  String get aiAssistant => 'Юридический помощник ИИ';
  ...
  String get disclaimer =>
      'Это справочная информация от ИИ, а не юридическая консультация. Всегда обращайтесь к юристу.';
  ...
  String get disclaimerFull =>
      'Это помощник на основе ИИ, а не юрист. Анализ ИИ может содержать ошибки. Всегда проверяйте информацию у квалифицированного юриста.';
