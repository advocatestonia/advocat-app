...
const UI_TRANSLATIONS = {
    en: {
        ...
        aiHint: 'Claude analyses the transcript every 15s and surfaces relevant legal information and statutes that may apply. Not legal advice.',
    ...
    ru: {
        ...
        aiHint: 'Claude анализирует транскрипцию каждые 15 сек и подсвечивает релевантную правовую информацию и применимые нормы. Это не юридическая консультация.',
        ...
        aiHint: 'Claude analysoi keskustelun 15 sekunnin välein ja nostaa esiin asiaan liittyvää oikeudellista tietoa ja sovellettavia pykäliä. Ei oikeudellinen neuvo.',
    ...
    et: {
        ...
        aiHint: 'Claude analüüsib transkriptsiooni iga 15 sek ja toob esile asjakohase õigusinfo ning kohaldatavad sätted. See ei ole õigusnõu.',
    ...
    de: {
        ...
        aiHint: 'Claude analysiert das Transkript alle 15 Sek. und zeigt relevante Rechtsinformationen und einschlägige Vorschriften. Keine Rechtsberatung.',
    ...
    sv: {
        ...
        aiHint: 'Claude analyserar transkriptionen var 15:e sekund och lyfter fram relevant juridisk information och tillämpliga paragrafer. Inte juridisk rådgivning.',
    ...
    uk: {
        ...
        aiHint: 'Claude аналізує транскрипцію кожні 15 сек і підсвічує релевантну правову інформацію та застосовні норми. Це не юридична консультація.',
    ...
    ar: {
        ...
        aiHint: 'يحلّل Claude النص كل 15 ثانية ويُبرز المعلومات القانونية ذات الصلة والمواد المنطبقة. ليست استشارة قانونية.',
    ...
    fr: {
        ...
        aiHint: 'Claude analyse la transcription toutes les 15 sec et met en évidence les informations juridiques pertinentes et les articles applicables. Pas un conseil juridique.',
    ...
    tr: {
        ...
        aiHint: 'Claude transkripti her 15 saniyede analiz eder ve ilgili hukuki bilgileri ve uygulanabilir mevzuatı öne çıkarır. Hukuki tavsiye değildir.',
    ...
    es: {
        ...
        aiHint: 'Claude analiza la transcripción cada 15 seg y resalta la información legal relevante y los artículos aplicables. No es asesoría legal.',
    ...
    pl: {
        ...
        aiHint: 'Claude analizuje transkrypcję co 15 sek i wskazuje istotne informacje prawne oraz właściwe przepisy. To nie jest porada prawna.',
    ...
    fa: {
        ...
        aiHint: 'Claude هر ۱۵ ثانیه رونوشت را تحلیل می‌کند و اطلاعات حقوقی مرتبط و مواد قابل اعمال را برجسته می‌نماید. مشاوره حقوقی نیست.',
    ...
    lt: {
        ...
        aiHint: 'Claude analizuoja transkripciją kas 15 sek. ir išryškina aktualią teisinę informaciją bei taikytinas normas. Tai nėra teisinė konsultacija.',
    ...
    lv: {
        ...
        aiHint: 'Claude analizē transkripciju ik 15 sek. un izceļ atbilstošu juridisku informāciju un piemērojamās normas. Tā nav juridiska konsultācija.',
    ...
    it: {
        ...
        aiHint: 'Claude analizza la trascrizione ogni 15 sec ed evidenzia le informazioni giuridiche pertinenti e gli articoli applicabili. Non è consulenza legale.',
    ...
    ro: {
        ...
        aiHint: 'Claude analizează transcrierea la fiecare 15 sec și evidențiază informațiile juridice relevante și articolele aplicabile. Nu este consiliere juridică.',
