// Pure auth-gate helper for reconcile-subscriptions.
// -----------------------------------------------------------------------------
// Same pattern as deadline-reminder/auth_gate.ts — extracted so the test
// importer doesn't trigger the top-level serve(...) HTTP listener in index.ts.
// -----------------------------------------------------------------------------
